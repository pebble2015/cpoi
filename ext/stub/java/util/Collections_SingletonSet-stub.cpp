...
void java::util::Collections_SingletonSet::forEach(::java::util::function::Consumer* action)
{ /* stub */
    unimplemented_(u"void java::util::Collections_SingletonSet::forEach(::java::util::function::Consumer* action)");
}
...
bool java::util::Collections_SingletonSet::removeIf(::java::util::function::Predicate* filter)
{ /* stub */
    unimplemented_(u"bool java::util::Collections_SingletonSet::removeIf(::java::util::function::Predicate* filter)");
    return 0;
}
...
java::util::Spliterator* java::util::Collections_SingletonSet::spliterator()
{ /* stub */
    unimplemented_(u"java::util::Spliterator* java::util::Collections_SingletonSet::spliterator()");
    return 0;
}
