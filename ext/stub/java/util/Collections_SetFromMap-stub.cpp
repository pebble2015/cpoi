...
void java::util::Collections_SetFromMap::forEach(::java::util::function::Consumer* action)
{ /* stub */
    unimplemented_(u"void java::util::Collections_SetFromMap::forEach(::java::util::function::Consumer* action)");
}
...
java::util::stream::Stream* java::util::Collections_SetFromMap::parallelStream()
{ /* stub */
    unimplemented_(u"java::util::stream::Stream* java::util::Collections_SetFromMap::parallelStream()");
    return 0;
}
...
bool java::util::Collections_SetFromMap::removeIf(::java::util::function::Predicate* filter)
{ /* stub */
    unimplemented_(u"bool java::util::Collections_SetFromMap::removeIf(::java::util::function::Predicate* filter)");
    return 0;
}
...
java::util::Spliterator* java::util::Collections_SetFromMap::spliterator()
{ /* stub */
    unimplemented_(u"java::util::Spliterator* java::util::Collections_SetFromMap::spliterator()");
    return 0;
}

java::util::stream::Stream* java::util::Collections_SetFromMap::stream()
{ /* stub */
    unimplemented_(u"java::util::stream::Stream* java::util::Collections_SetFromMap::stream()");
    return 0;
}
