...
void java::util::Arrays_ArrayList::forEach(::java::util::function::Consumer* action)
{ /* stub */
    unimplemented_(u"void java::util::Arrays_ArrayList::forEach(::java::util::function::Consumer* action)");
}
...
void java::util::Arrays_ArrayList::replaceAll(::java::util::function::UnaryOperator* operator_)
{ /* stub */
    unimplemented_(u"void java::util::Arrays_ArrayList::replaceAll(::java::util::function::UnaryOperator* operator_)");
}
...
void java::util::Arrays_ArrayList::sort(Comparator* c)
{ /* stub */
    unimplemented_(u"void java::util::Arrays_ArrayList::sort(Comparator* c)");
}

java::util::Spliterator* java::util::Arrays_ArrayList::spliterator()
{ /* stub */
    unimplemented_(u"java::util::Spliterator* java::util::Arrays_ArrayList::spliterator()");
    return 0;
}
