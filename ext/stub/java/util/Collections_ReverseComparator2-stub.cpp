...
java::util::Comparator* java::util::Collections_ReverseComparator2::reversed()
{ /* stub */
    unimplemented_(u"java::util::Comparator* java::util::Collections_ReverseComparator2::reversed()");
    return 0;
}
