...
java::util::TreeMap_DescendingKeyIterator::TreeMap_DescendingKeyIterator(TreeMap *TreeMap_this, TreeMap_Entry* first)
...
void ::java::util::TreeMap_DescendingKeyIterator::ctor(TreeMap_Entry* first)
{ /* stub */
    /* super::ctor(); */
    unimplemented_(u"void ::java::util::TreeMap_DescendingKeyIterator::ctor(TreeMap_Entry* first)");
}
