...
void java::util::Collections_AsLIFOQueue::forEach(::java::util::function::Consumer* action)
{ /* stub */
    unimplemented_(u"void java::util::Collections_AsLIFOQueue::forEach(::java::util::function::Consumer* action)");
}
...
java::util::stream::Stream* java::util::Collections_AsLIFOQueue::parallelStream()
{ /* stub */
    unimplemented_(u"java::util::stream::Stream* java::util::Collections_AsLIFOQueue::parallelStream()");
    return 0;
}
...
bool java::util::Collections_AsLIFOQueue::removeIf(::java::util::function::Predicate* filter)
{ /* stub */
    unimplemented_(u"bool java::util::Collections_AsLIFOQueue::removeIf(::java::util::function::Predicate* filter)");
    return 0;
}
...
java::util::Spliterator* java::util::Collections_AsLIFOQueue::spliterator()
{ /* stub */
    unimplemented_(u"java::util::Spliterator* java::util::Collections_AsLIFOQueue::spliterator()");
    return 0;
}

java::util::stream::Stream* java::util::Collections_AsLIFOQueue::stream()
{ /* stub */
    unimplemented_(u"java::util::stream::Stream* java::util::Collections_AsLIFOQueue::stream()");
    return 0;
}
