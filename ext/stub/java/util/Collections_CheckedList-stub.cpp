...
void java::util::Collections_CheckedList::replaceAll(::java::util::function::UnaryOperator* operator_)
{ /* stub */
    unimplemented_(u"void java::util::Collections_CheckedList::replaceAll(::java::util::function::UnaryOperator* operator_)");
}
...
void java::util::Collections_CheckedList::sort(Comparator* c)
{ /* stub */
    unimplemented_(u"void java::util::Collections_CheckedList::sort(Comparator* c)");
}
...
bool java::util::Collections_CheckedList::removeIf(::java::util::function::Predicate* filter)
{
