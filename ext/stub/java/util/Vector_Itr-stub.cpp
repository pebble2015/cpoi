...
void java::util::Vector_Itr::forEachRemaining(::java::util::function::Consumer* action)
{ /* stub */
    unimplemented_(u"void java::util::Vector_Itr::forEachRemaining(::java::util::function::Consumer* action)");
}
