...
java::util::function::Predicate* java::util::regex::Pattern::asPredicate()
{ /* stub */
    unimplemented_(u"java::util::function::Predicate* java::util::regex::Pattern::asPredicate()");
    return 0;
}
...
/* private: int32_t java::util::regex::Pattern::escape(bool inclass, bool create, bool isrange) */
...
java::util::stream::Stream* java::util::regex::Pattern::splitAsStream(::java::lang::CharSequence* input)
{ /* stub */
    unimplemented_(u"java::util::stream::Stream* java::util::regex::Pattern::splitAsStream(::java::lang::CharSequence* input)");
    return 0;
}
