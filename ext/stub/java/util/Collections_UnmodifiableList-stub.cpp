...
void java::util::Collections_UnmodifiableList::replaceAll(::java::util::function::UnaryOperator* operator_)
{ /* stub */
    unimplemented_(u"void java::util::Collections_UnmodifiableList::replaceAll(::java::util::function::UnaryOperator* operator_)");
}
...
void java::util::Collections_UnmodifiableList::sort(Comparator* c)
{ /* stub */
    unimplemented_(u"void java::util::Collections_UnmodifiableList::sort(Comparator* c)");
}
