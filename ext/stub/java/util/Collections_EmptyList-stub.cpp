...
void java::util::Collections_EmptyList::forEach(::java::util::function::Consumer* action)
{ /* stub */
    unimplemented_(u"void java::util::Collections_EmptyList::forEach(::java::util::function::Consumer* action)");
}
...
bool java::util::Collections_EmptyList::removeIf(::java::util::function::Predicate* filter)
{ /* stub */
    unimplemented_(u"bool java::util::Collections_EmptyList::removeIf(::java::util::function::Predicate* filter)");
    return 0;
}

void java::util::Collections_EmptyList::replaceAll(::java::util::function::UnaryOperator* operator_)
{ /* stub */
    unimplemented_(u"void java::util::Collections_EmptyList::replaceAll(::java::util::function::UnaryOperator* operator_)");
}
...
void java::util::Collections_EmptyList::sort(Comparator* c)
{ /* stub */
    unimplemented_(u"void java::util::Collections_EmptyList::sort(Comparator* c)");
}

java::util::Spliterator* java::util::Collections_EmptyList::spliterator()
{ /* stub */
    unimplemented_(u"java::util::Spliterator* java::util::Collections_EmptyList::spliterator()");
    return 0;
}
