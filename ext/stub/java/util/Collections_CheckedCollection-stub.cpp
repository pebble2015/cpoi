...
void java::util::Collections_CheckedCollection::forEach(::java::util::function::Consumer* action)
{ /* stub */
    unimplemented_(u"void java::util::Collections_CheckedCollection::forEach(::java::util::function::Consumer* action)");
}
...
java::util::stream::Stream* java::util::Collections_CheckedCollection::parallelStream()
{ /* stub */
    unimplemented_(u"java::util::stream::Stream* java::util::Collections_CheckedCollection::parallelStream()");
    return 0;
}
...
bool java::util::Collections_CheckedCollection::removeIf(::java::util::function::Predicate* filter)
{ /* stub */
    unimplemented_(u"bool java::util::Collections_CheckedCollection::removeIf(::java::util::function::Predicate* filter)");
    return 0;
}
...
java::util::Spliterator* java::util::Collections_CheckedCollection::spliterator()
{ /* stub */
    unimplemented_(u"java::util::Spliterator* java::util::Collections_CheckedCollection::spliterator()");
    return 0;
}

java::util::stream::Stream* java::util::Collections_CheckedCollection::stream()
{ /* stub */
    unimplemented_(u"java::util::stream::Stream* java::util::Collections_CheckedCollection::stream()");
    return 0;
}
...
java::lang::Object* java::util::Collections_CheckedCollection::typeCheck(::java::lang::Object* o)
{ /* stub */
    unimplemented_(u"java::lang::Object* java::util::Collections_CheckedCollection::typeCheck(::java::lang::Object* o)");
    return 0;
}
