...
std::atomic< java::util::Locale* >& java::util::Locale::defaultDisplayLocale()
{
    clinit();
    return defaultDisplayLocale_;
}
std::atomic< java::util::Locale* > java::util::Locale::defaultDisplayLocale_;
std::atomic< java::util::Locale* >& java::util::Locale::defaultFormatLocale()
{
    clinit();
    return defaultFormatLocale_;
}
std::atomic< java::util::Locale* > java::util::Locale::defaultFormatLocale_;
std::atomic< java::util::Locale* >& java::util::Locale::defaultLocale()
{
    clinit();
    return defaultLocale_;
}
std::atomic< java::util::Locale* > java::util::Locale::defaultLocale_;
...
java::util::List* java::util::Locale::filter(List* priorityList, Collection* locales)
{ /* stub */
    clinit();
    unimplemented_(u"java::util::List* java::util::Locale::filter(List* priorityList, Collection* locales)");
    return 0;
}

java::util::List* java::util::Locale::filter(List* priorityList, Collection* locales, Locale_FilteringMode* mode)
{ /* stub */
    clinit();
    unimplemented_(u"java::util::List* java::util::Locale::filter(List* priorityList, Collection* locales, Locale_FilteringMode* mode)");
    return 0;
}

java::util::List* java::util::Locale::filterTags(List* priorityList, Collection* tags)
{ /* stub */
    clinit();
    unimplemented_(u"java::util::List* java::util::Locale::filterTags(List* priorityList, Collection* tags)");
    return 0;
}

java::util::List* java::util::Locale::filterTags(List* priorityList, Collection* tags, Locale_FilteringMode* mode)
{ /* stub */
    clinit();
    unimplemented_(u"java::util::List* java::util::Locale::filterTags(List* priorityList, Collection* tags, Locale_FilteringMode* mode)");
    return 0;
}
...
/* private: java::lang::StringArray* java::util::Locale::getDisplayVariantArray_(Locale* inLocale) */
...
bool java::util::Locale::hasExtensions()
{ /* stub */
    unimplemented_(u"bool java::util::Locale::hasExtensions()");
    return 0;
}
...
/* private: java::util::Locale* java::util::Locale::initDefault() */
/* private: java::util::Locale* java::util::Locale::initDefault(Locale_Category* category) */
/* private: bool java::util::Locale::isUnicodeExtensionKey(::java::lang::String* s) */
java::util::Locale* java::util::Locale::lookup(List* priorityList, Collection* locales)
{ /* stub */
    clinit();
    unimplemented_(u"java::util::Locale* java::util::Locale::lookup(List* priorityList, Collection* locales)");
    return 0;
}

java::lang::String* java::util::Locale::lookupTag(List* priorityList, Collection* tags)
{ /* stub */
    clinit();
    unimplemented_(u"java::lang::String* java::util::Locale::lookupTag(List* priorityList, Collection* tags)");
    return 0;
}
...
{ /* stub */
    unimplemented_(u"java::util::Locale* java::util::Locale::stripExtensions()");
    return 0;
}
