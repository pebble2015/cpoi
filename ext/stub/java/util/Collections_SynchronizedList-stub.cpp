...
void java::util::Collections_SynchronizedList::replaceAll(::java::util::function::UnaryOperator* operator_)
{ /* stub */
    unimplemented_(u"void java::util::Collections_SynchronizedList::replaceAll(::java::util::function::UnaryOperator* operator_)");
}
...
void java::util::Collections_SynchronizedList::sort(Comparator* c)
{ /* stub */
    unimplemented_(u"void java::util::Collections_SynchronizedList::sort(Comparator* c)");
}
