...
bool java::util::spi::LocaleServiceProvider::isSupportedLocale(::java::util::Locale* locale)
{ /* stub */
    unimplemented_(u"bool java::util::spi::LocaleServiceProvider::isSupportedLocale(::java::util::Locale* locale)");
    return 0;
}
