...
void java::util::Collections_EmptyIterator::forEachRemaining(::java::util::function::Consumer* action)
{ /* stub */
    unimplemented_(u"void java::util::Collections_EmptyIterator::forEachRemaining(::java::util::function::Consumer* action)");
}
