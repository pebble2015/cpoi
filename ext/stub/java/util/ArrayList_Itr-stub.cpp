...
void java::util::ArrayList_Itr::forEachRemaining(::java::util::function::Consumer* consumer)
{ /* stub */
    unimplemented_(u"void java::util::ArrayList_Itr::forEachRemaining(::java::util::function::Consumer* consumer)");
}
