...
java::text::AttributedCharacterIterator_Attribute::AttributedCharacterIterator_Attribute(::java::lang::String* name)
...
void ::java::text::AttributedCharacterIterator_Attribute::ctor(::java::lang::String* name)
{ /* stub */
    /* super::ctor(); */
    unimplemented_(u"void ::java::text::AttributedCharacterIterator_Attribute::ctor(::java::lang::String* name)");
}

bool java::text::AttributedCharacterIterator_Attribute::equals(::java::lang::Object* obj)
{ /* stub */
    unimplemented_(u"bool java::text::AttributedCharacterIterator_Attribute::equals(::java::lang::Object* obj)");
    return 0;
}
