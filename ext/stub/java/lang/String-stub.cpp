...
int32_t java::lang::String::indexOf(::char16_tArray* source, int32_t sourceOffset, int32_t sourceCount, String* target, int32_t fromIndex)
{ /* stub */
    clinit();
    unimplemented_(u"int32_t java::lang::String::indexOf(::char16_tArray* source, int32_t sourceOffset, int32_t sourceCount, String* target, int32_t fromIndex)");
    return 0;
}
...
java::lang::String* java::lang::String::join(CharSequence* delimiter, CharSequenceArray* elements)
{ /* stub */
    clinit();
    unimplemented_(u"java::lang::String* java::lang::String::join(CharSequence* delimiter, CharSequenceArray* elements)");
    return 0;
}

java::lang::String* java::lang::String::join(CharSequence* delimiter, Iterable* elements)
{ /* stub */
    clinit();
    unimplemented_(u"java::lang::String* java::lang::String::join(CharSequence* delimiter, Iterable* elements)");
    return 0;
}
...
int32_t java::lang::String::lastIndexOf(::char16_tArray* source, int32_t sourceOffset, int32_t sourceCount, String* target, int32_t fromIndex)
{ /* stub */
    clinit();
    unimplemented_(u"int32_t java::lang::String::lastIndexOf(::char16_tArray* source, int32_t sourceOffset, int32_t sourceCount, String* target, int32_t fromIndex)");
    return 0;
}
...
/* private: bool java::lang::String::nonSyncContentEquals(AbstractStringBuilder* sb) */
