...
java::lang::reflect::Constructor::Constructor(::java::lang::Class* declaringClass, ::java::lang::ClassArray* parameterTypes, ::java::lang::ClassArray* checkedExceptions, int32_t modifiers, int32_t slot, ::java::lang::String* signature, ::int8_tArray* annotations, ::int8_tArray* parameterAnnotations)
    : Constructor(*static_cast< ::default_init_tag* >(0))
{
    ctor(declaringClass, parameterTypes, checkedExceptions, modifiers, slot, signature, annotations, parameterAnnotations);
}


void ::java::lang::reflect::Constructor::ctor(::java::lang::Class* declaringClass, ::java::lang::ClassArray* parameterTypes, ::java::lang::ClassArray* checkedExceptions, int32_t modifiers, int32_t slot, ::java::lang::String* signature, ::int8_tArray* annotations, ::int8_tArray* parameterAnnotations)
{ /* stub */
    /* super::ctor(); */
    unimplemented_(u"void ::java::lang::reflect::Constructor::ctor(::java::lang::Class* declaringClass, ::java::lang::ClassArray* parameterTypes, ::java::lang::ClassArray* checkedExceptions, int32_t modifiers, int32_t slot, ::java::lang::String* signature, ::int8_tArray* annotations, ::int8_tArray* parameterAnnotations)");
}
...
bool java::lang::reflect::Constructor::equals(::java::lang::Object* obj)
{ /* stub */
    unimplemented_(u"bool java::lang::reflect::Constructor::equals(::java::lang::Object* obj)");
    return 0;
}
...
java::lang::annotation::Annotation* java::lang::reflect::Constructor::getAnnotation(::java::lang::Class* annotationClass)
{ /* stub */
    unimplemented_(u"java::lang::annotation::Annotation* java::lang::reflect::Constructor::getAnnotation(::java::lang::Class* annotationClass)");
    return 0;
}
...
void java::lang::reflect::Constructor::handleParameterNumberMismatch(int32_t resultLength, int32_t numParameters)
{ /* stub */
    unimplemented_(u"void java::lang::reflect::Constructor::handleParameterNumberMismatch(int32_t resultLength, int32_t numParameters)");
}
...
java::lang::Object* java::lang::reflect::Constructor::newInstance(::java::lang::ObjectArray* initargs)
{ /* stub */
    unimplemented_(u"java::lang::Object* java::lang::reflect::Constructor::newInstance(::java::lang::ObjectArray* initargs)");
    return 0;
}

void java::lang::reflect::Constructor::setConstructorAccessor(::sun::reflect::ConstructorAccessor* accessor)
{ /* stub */
    this->constructorAccessor = accessor; /* setter */
}

void java::lang::reflect::Constructor::specificToGenericStringHeader(::java::lang::StringBuilder* sb)
{ /* stub */
    unimplemented_(u"void java::lang::reflect::Constructor::specificToGenericStringHeader(::java::lang::StringBuilder* sb)");
}

void java::lang::reflect::Constructor::specificToStringHeader(::java::lang::StringBuilder* sb)
{ /* stub */
    unimplemented_(u"void java::lang::reflect::Constructor::specificToStringHeader(::java::lang::StringBuilder* sb)");
}
