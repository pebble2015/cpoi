...
constexpr int32_t java::lang::Double::BYTES;
...
int32_t java::lang::Double::hashCode(double value)
{ /* stub */
    clinit();
    unimplemented_(u"int32_t java::lang::Double::hashCode(double value)");
    return 0;
}
...
{ /* stub */
    clinit();
    unimplemented_(u"bool java::lang::Double::isFinite(double d)");
    return 0;
}
...
{ /* stub */
    clinit();
    unimplemented_(u"double java::lang::Double::max(double a, double b)");
    return 0;
}
...
{ /* stub */
    clinit();
    unimplemented_(u"double java::lang::Double::min(double a, double b)");
    return 0;
}
...
{ /* stub */
    clinit();
    unimplemented_(u"double java::lang::Double::sum(double a, double b)");
    return 0;
}
