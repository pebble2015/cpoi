...
int32_t java::lang::Boolean::hashCode(bool value)
{ /* stub */
    clinit();
    unimplemented_(u"int32_t java::lang::Boolean::hashCode(bool value)");
    return 0;
}
...
{ /* stub */
    clinit();
    unimplemented_(u"bool java::lang::Boolean::logicalAnd(bool a, bool b)");
    return 0;
}
...
{ /* stub */
    clinit();
    unimplemented_(u"bool java::lang::Boolean::logicalOr(bool a, bool b)");
    return 0;
}
...
{ /* stub */
    clinit();
    unimplemented_(u"bool java::lang::Boolean::logicalXor(bool a, bool b)");
    return 0;
}
