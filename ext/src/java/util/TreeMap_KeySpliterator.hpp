...
class java::util::TreeMap_KeySpliterator final
...
public:
    ...
    TreeMap_KeySpliterator* trySplit() override;

    // Generated

public: /* package */
    TreeMap_KeySpliterator(TreeMap* tree, TreeMap_Entry* origin, TreeMap_Entry* fence, int32_t side, int32_t est, int32_t expectedModCount);
protected:
    TreeMap_KeySpliterator(const ::default_init_tag&);
