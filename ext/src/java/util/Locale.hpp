...
private:
    ...
    static std::atomic< Locale* > defaultDisplayLocale_;
    static std::atomic< Locale* > defaultFormatLocale_;
    static std::atomic< Locale* > defaultLocale_;
    ...
    std::atomic< ::java::lang::String* > languageTag {  };
...
public:
    ...
    static List* filter(List* priorityList, Collection* locales);
    static List* filter(List* priorityList, Collection* locales, Locale_FilteringMode* mode);
    static List* filterTags(List* priorityList, Collection* tags);
    static List* filterTags(List* priorityList, Collection* tags, Locale_FilteringMode* mode);
...
public:
    ...
    /*::java::lang::StringArray* getDisplayVariantArray_(Locale* inLocale); (private) */
...
public:
    ...
    /*static Locale* initDefault(); (private) */
    /*static Locale* initDefault(Locale_Category* category); (private) */
    /*static bool isUnicodeExtensionKey(::java::lang::String* s); (private) */
    static Locale* lookup(List* priorityList, Collection* locales);
    static ::java::lang::String* lookupTag(List* priorityList, Collection* tags);
...
private:
    static std::atomic< Locale* >& defaultDisplayLocale();
    static std::atomic< Locale* >& defaultFormatLocale();
    static std::atomic< Locale* >& defaultLocale();
