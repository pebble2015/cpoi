...
class java::util::TreeMap_ValueSpliterator final
...
public:
    ...
    TreeMap_ValueSpliterator* trySplit() override;

    // Generated

public: /* package */
    TreeMap_ValueSpliterator(TreeMap* tree, TreeMap_Entry* origin, TreeMap_Entry* fence, int32_t side, int32_t est, int32_t expectedModCount);
protected:
    TreeMap_ValueSpliterator(const ::default_init_tag&);
