...
class java::util::HashMap_KeySpliterator final
...
public:
    ...
    HashMap_KeySpliterator* trySplit() override;

    // Generated

public: /* package */
    HashMap_KeySpliterator(HashMap* m, int32_t origin, int32_t fence, int32_t est, int32_t expectedModCount);
protected:
    HashMap_KeySpliterator(const ::default_init_tag&);
