...
class java::util::TreeMap_DescendingSubMap final
...
private:
    ...
    static constexpr int64_t serialVersionUID { int64_t(912986545866120460LL) };
...
public: /* package */
    TreeMap_DescendingSubMap(TreeMap* m, bool fromStart, ::java::lang::Object* lo, bool loInclusive, bool toEnd, ::java::lang::Object* hi, bool hiInclusive);
protected:
    TreeMap_DescendingSubMap(const ::default_init_tag&);
