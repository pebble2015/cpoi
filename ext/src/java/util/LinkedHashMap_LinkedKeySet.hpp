...
class java::util::LinkedHashMap_LinkedKeySet final
    : public AbstractSet
{
...
public: /* package */
    LinkedHashMap_LinkedKeySet(LinkedHashMap *LinkedHashMap_this);
protected:
    LinkedHashMap_LinkedKeySet(LinkedHashMap *LinkedHashMap_this, const ::default_init_tag&);
