...
public:
    ...
    static NavigableMap* checkedNavigableMap(NavigableMap* m, ::java::lang::Class* keyType, ::java::lang::Class* valueType);
    static NavigableSet* checkedNavigableSet(NavigableSet* s, ::java::lang::Class* type);
    static Queue* checkedQueue(Queue* queue, ::java::lang::Class* type);
...
public: /* package */
    static Spliterator* singletonSpliterator(::java::lang::Object* element);
