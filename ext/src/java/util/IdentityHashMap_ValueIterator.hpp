...
class java::util::IdentityHashMap_ValueIterator
...
public:
    ...
    // Generated
    IdentityHashMap_ValueIterator(IdentityHashMap *IdentityHashMap_this);
protected:
    IdentityHashMap_ValueIterator(IdentityHashMap *IdentityHashMap_this, const ::default_init_tag&);
