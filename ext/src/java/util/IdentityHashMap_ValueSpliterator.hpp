...
class java::util::IdentityHashMap_ValueSpliterator final
...
public:
    ...
    IdentityHashMap_ValueSpliterator* trySplit() override;

    // Generated

public: /* package */
    IdentityHashMap_ValueSpliterator(IdentityHashMap* m, int32_t origin, int32_t fence, int32_t est, int32_t expectedModCount);
protected:
    IdentityHashMap_ValueSpliterator(const ::default_init_tag&);
