...
class java::util::WeakHashMap_KeySpliterator final
...
public:
    ...
    WeakHashMap_KeySpliterator* trySplit() override;

    // Generated

public: /* package */
    WeakHashMap_KeySpliterator(WeakHashMap* m, int32_t origin, int32_t fence, int32_t est, int32_t expectedModCount);
protected:
    WeakHashMap_KeySpliterator(const ::default_init_tag&);
