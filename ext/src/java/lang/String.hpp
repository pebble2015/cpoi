...
public: /* package */
    static int32_t indexOf(::char16_tArray* source, int32_t sourceOffset, int32_t sourceCount, String* target, int32_t fromIndex);
...
public:
    String* intern();
    bool isEmpty();
    static String* join(CharSequence* delimiter, CharSequenceArray* elements);
...
public: /* package */
    static int32_t lastIndexOf(::char16_tArray* source, int32_t sourceOffset, int32_t sourceCount, String* target, int32_t fromIndex);
...
public:
    ...
    /*bool nonSyncContentEquals(AbstractStringBuilder* sb); (private) */
