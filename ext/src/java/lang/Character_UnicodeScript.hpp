...
public:
    ...
    static Character_UnicodeScript* CHAKMA;
    ...
    static Character_UnicodeScript* MEROITIC_CURSIVE;
    static Character_UnicodeScript* MEROITIC_HIEROGLYPHS;
    static Character_UnicodeScript* MIAO;
    ...
    static Character_UnicodeScript* SHARADA;
    static Character_UnicodeScript* SHAVIAN;
    static Character_UnicodeScript* SINHALA;
    static Character_UnicodeScript* SORA_SOMPENG;
    ...
    static Character_UnicodeScript* TAKRI;
