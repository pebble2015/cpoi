...
public:
    ...
    /*void init_(ThreadGroup* g, Runnable* target, String* name, int64_t stackSize, ::java::security::AccessControlContext* acc, bool inheritThreadLocals); (private) */
