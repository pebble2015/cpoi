...
class org::apache::commons::collections4::bidimap::TreeBidiMap_ValueView
...
public:
    ...
    // Generated
    TreeBidiMap_ValueView(TreeBidiMap *TreeBidiMap_this, TreeBidiMap_DataElement* orderType);
protected:
    TreeBidiMap_ValueView(TreeBidiMap *TreeBidiMap_this, const ::default_init_tag&);
