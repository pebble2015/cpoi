...
class org::apache::commons::collections4::bidimap::TreeBidiMap_ViewMapEntryIterator
...
public: /* package */
    TreeBidiMap_ViewMapEntryIterator(TreeBidiMap *TreeBidiMap_this);
protected:
    TreeBidiMap_ViewMapEntryIterator(TreeBidiMap *TreeBidiMap_this, const ::default_init_tag&);
