...
class org::apache::commons::collections4::bidimap::TreeBidiMap_InverseViewMapIterator
...
public:
    ...
    // Generated
    TreeBidiMap_InverseViewMapIterator(TreeBidiMap *TreeBidiMap_this, TreeBidiMap_DataElement* orderType);
protected:
    TreeBidiMap_InverseViewMapIterator(TreeBidiMap *TreeBidiMap_this, const ::default_init_tag&);
