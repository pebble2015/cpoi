...
class org::apache::commons::collections4::bidimap::TreeBidiMap_EntryView
...
public: /* package */
    TreeBidiMap_EntryView(TreeBidiMap *TreeBidiMap_this);
protected:
    TreeBidiMap_EntryView(TreeBidiMap *TreeBidiMap_this, const ::default_init_tag&);
