...
poi::sl::draw::DrawFontManagerDefault::DrawFontManagerDefault(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::sl::draw::DrawFontManagerDefault::DrawFontManagerDefault()
    : DrawFontManagerDefault(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

poi::common::usermodel::fonts::FontInfo* poi::sl::draw::DrawFontManagerDefault::getMappedFont(::java::awt::Graphics2D* graphics, ::poi::common::usermodel::fonts::FontInfo* fontInfo)
{
    return getFontWithFallback(graphics, Drawable::FONT_MAP(), fontInfo);
}

poi::common::usermodel::fonts::FontInfo* poi::sl::draw::DrawFontManagerDefault::getFallbackFont(::java::awt::Graphics2D* graphics, ::poi::common::usermodel::fonts::FontInfo* fontInfo)
{
...
java::lang::String* poi::sl::draw::DrawFontManagerDefault::mapFontCharset(::java::awt::Graphics2D* graphics, ::poi::common::usermodel::fonts::FontInfo* fontInfo, ::java::lang::String* text)
{
    auto attStr = text;
...
java::awt::Font* poi::sl::draw::DrawFontManagerDefault::createAWTFont(::java::awt::Graphics2D* graphics, ::poi::common::usermodel::fonts::FontInfo* fontInfo, double fontSize, bool bold, bool italic)
{
...
poi::common::usermodel::fonts::FontInfo* poi::sl::draw::DrawFontManagerDefault::getFontWithFallback(::java::awt::Graphics2D* graphics, Drawable_DrawableHint* hint, ::poi::common::usermodel::fonts::FontInfo* fontInfo)
{
    ...
    return (mappedTypeface != nullptr) ? static_cast< ::poi::common::usermodel::fonts::FontInfo* >(new DrawFontInfo(mappedTypeface)) : fontInfo;
}

extern java::lang::Class *class_(const char16_t *c, int n);

java::lang::Class* poi::sl::draw::DrawFontManagerDefault::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.sl.draw.DrawFontManagerDefault", 45);
    return c;
}

java::lang::Class* poi::sl::draw::DrawFontManagerDefault::getClass0()
{
    return class_();
}
