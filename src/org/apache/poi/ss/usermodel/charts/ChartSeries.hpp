...
struct poi::ss::usermodel::charts::ChartSeries
    : public virtual ::java::lang::Object
{
    virtual void setTitle(::java::lang::String* title) = 0;
    virtual void setTitle(::poi::ss::util::CellReference* titleReference) = 0;
    virtual ::java::lang::String* getTitleString() = 0;
    virtual ::poi::ss::util::CellReference* getTitleCellReference() = 0;
