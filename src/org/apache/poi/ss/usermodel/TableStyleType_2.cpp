...
org::apache::poi::ss::usermodel::TableStyleType_2::TableStyleType_2(::java::lang::String* name, int ordinal)
...
org::apache::poi::ss::util::CellRangeAddressBase* org::apache::poi::ss::usermodel::TableStyleType_2::getRange(Table* table, Cell* cell)
{
    ...
    while (true) {
        ...
        if(c >= firstStart && c <= secondStart - int32_t(1))
            return new ::org::apache::poi::ss::util::CellRangeAddress(npc(table)->getStartRowIndex(), npc(table)->getEndRowIndex(), firstStart, secondStart - int32_t(1));
...
java::lang::Class* org::apache::poi::ss::usermodel::TableStyleType_2::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* org::apache::poi::ss::usermodel::TableStyleType_2::getClass0()
{
    return class_();
}
