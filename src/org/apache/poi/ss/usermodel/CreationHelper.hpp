...
struct poi::ss::usermodel::CreationHelper
    : public virtual ::java::lang::Object
{
    virtual RichTextString* createRichTextString(::java::lang::String* text) = 0;
    virtual DataFormat* createDataFormat() = 0;
    virtual Hyperlink* createHyperlink(::poi::common::usermodel::HyperlinkType* type) = 0;
    ...
    virtual ::poi::ss::util::AreaReference* createAreaReference(::java::lang::String* reference) = 0;
    virtual ::poi::ss::util::AreaReference* createAreaReference(::poi::ss::util::CellReference* topLeft, ::poi::ss::util::CellReference* bottomRight) = 0;
