...
poi::ss::usermodel::TableStyleType_4::TableStyleType_4(::java::lang::String* name, int ordinal)
...
poi::ss::util::CellRangeAddressBase* poi::ss::usermodel::TableStyleType_4::getRange(Table* table, Cell* cell)
{
    ...
    while (true) {
        ...
        if(c >= firstStart && c <= secondStart - int32_t(1))
            return new ::poi::ss::util::CellRangeAddress(firstStart, secondStart - int32_t(1), npc(table)->getStartColIndex(), npc(table)->getEndColIndex());
...
java::lang::Class* poi::ss::usermodel::TableStyleType_4::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* poi::ss::usermodel::TableStyleType_4::getClass0()
{
    return class_();
}
