...
struct org::apache::poi::ss::usermodel::SheetConditionalFormatting
    : public virtual ::java::lang::Object
{
    virtual int32_t addConditionalFormatting(::org::apache::poi::ss::util::CellRangeAddressArray* regions, ConditionalFormattingRule* rule) = 0;
    virtual int32_t addConditionalFormatting(::org::apache::poi::ss::util::CellRangeAddressArray* regions, ConditionalFormattingRule* rule1, ConditionalFormattingRule* rule2) = 0;
    virtual int32_t addConditionalFormatting(::org::apache::poi::ss::util::CellRangeAddressArray* regions, ConditionalFormattingRuleArray* cfRules) = 0;
