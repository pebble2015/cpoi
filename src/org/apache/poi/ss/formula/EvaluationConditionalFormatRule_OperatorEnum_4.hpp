...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_OperatorEnum_4 final
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_OperatorEnum_4(::java::lang::String* name, int ordinal);
