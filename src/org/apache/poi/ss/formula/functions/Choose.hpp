...
class org::apache::poi::ss::formula::functions::Choose final
...
public:
    ...
    static int32_t evaluateFirstArg(::org::apache::poi::ss::formula::eval::ValueEval* arg0, int32_t srcRowIndex, int32_t srcColumnIndex) /* throws(EvaluationException) */;
