...
class org::apache::poi::ss::formula::functions::Na final
    : public Fixed0ArgFunction
{

public:
    typedef Fixed0ArgFunction super;
    ::org::apache::poi::ss::formula::eval::ValueEval* evaluate(int32_t srcCellRow, int32_t srcCellCol) override;

    // Generated
    Na();
protected:
    Na(const ::default_init_tag&);
