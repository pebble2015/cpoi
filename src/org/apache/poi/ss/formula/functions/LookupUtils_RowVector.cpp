...
poi::ss::formula::functions::LookupUtils_RowVector::LookupUtils_RowVector(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ss::formula::functions::LookupUtils_RowVector::LookupUtils_RowVector(::poi::ss::formula::TwoDEval* tableArray_, int32_t rowIndex) 
    : LookupUtils_RowVector(*static_cast< ::default_init_tag* >(0))
{
    ctor(tableArray_,rowIndex);
}

void poi::ss::formula::functions::LookupUtils_RowVector::ctor(::poi::ss::formula::TwoDEval* tableArray_, int32_t rowIndex)
{
    super::ctor();
    _rowIndex = rowIndex;
...
poi::ss::formula::eval::ValueEval* poi::ss::formula::functions::LookupUtils_RowVector::getItem(int32_t index)
{
    if(index > _size) {
...
int32_t poi::ss::formula::functions::LookupUtils_RowVector::getSize()
{
    return _size;
}
...
java::lang::Class* poi::ss::formula::functions::LookupUtils_RowVector::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ss.formula.functions.LookupUtils.RowVector", 57);
    return c;
}

java::lang::Class* poi::ss::formula::functions::LookupUtils_RowVector::getClass0()
{
    return class_();
}
