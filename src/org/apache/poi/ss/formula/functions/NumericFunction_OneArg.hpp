...
class org::apache::poi::ss::formula::functions::NumericFunction_OneArg
...
public: /* protected */
    double eval(::org::apache::poi::ss::formula::eval::ValueEvalArray* args, int32_t srcCellRow, int32_t srcCellCol) /* throws(EvaluationException) */;
    virtual double evaluate(double d) /* throws(EvaluationException) */ = 0;

    // Generated
    NumericFunction_OneArg();
protected:
    NumericFunction_OneArg(const ::default_init_tag&);
