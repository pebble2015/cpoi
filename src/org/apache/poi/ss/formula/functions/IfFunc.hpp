...
class org::apache::poi::ss::formula::functions::IfFunc final
...
public:
    ...
    static bool evaluateFirstArg(::org::apache::poi::ss::formula::eval::ValueEval* arg, int32_t srcCellRow, int32_t srcCellCol) /* throws(EvaluationException) */;

    // Generated
    IfFunc();
protected:
    IfFunc(const ::default_init_tag&);
