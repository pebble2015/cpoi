...
class poi::ss::formula::functions::IfFunc final
...
public:
    ...
    static bool evaluateFirstArg(::poi::ss::formula::eval::ValueEval* arg, int32_t srcCellRow, int32_t srcCellCol) /* throws(EvaluationException) */;
