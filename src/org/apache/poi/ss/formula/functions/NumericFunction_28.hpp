...
class org::apache::poi::ss::formula::functions::NumericFunction_28
    : public NumericFunction_TwoArg
{

public:
    typedef NumericFunction_TwoArg super;

public: /* protected */
    double evaluate(double d0, double d1) /* throws(EvaluationException) */ override;
...
public:
    ...
    ::org::apache::poi::ss::formula::eval::ValueEval* evaluate(int32_t srcRowIndex, int32_t srcColumnIndex, ::org::apache::poi::ss::formula::eval::ValueEval* arg0, ::org::apache::poi::ss::formula::eval::ValueEval* arg1);
