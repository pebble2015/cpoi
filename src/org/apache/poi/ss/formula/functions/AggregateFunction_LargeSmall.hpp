...
class org::apache::poi::ss::formula::functions::AggregateFunction_LargeSmall final
...
public: /* protected */
    AggregateFunction_LargeSmall(bool isLarge);
protected:
    AggregateFunction_LargeSmall(const ::default_init_tag&);
