...
class poi::ss::formula::functions::Code
    : public Fixed1ArgFunction
{

public:
    typedef Fixed1ArgFunction super;
    ::poi::ss::formula::eval::ValueEval* evaluate(int32_t srcRowIndex, int32_t srcColumnIndex, ::poi::ss::formula::eval::ValueEval* textArg) override;
