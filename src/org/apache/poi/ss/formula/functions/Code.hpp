...
class org::apache::poi::ss::formula::functions::Code
    : public Fixed1ArgFunction
{

public:
    typedef Fixed1ArgFunction super;
    ::org::apache::poi::ss::formula::eval::ValueEval* evaluate(int32_t srcRowIndex, int32_t srcColumnIndex, ::org::apache::poi::ss::formula::eval::ValueEval* textArg) override;

    // Generated
    Code();
protected:
    Code(const ::default_init_tag&);
