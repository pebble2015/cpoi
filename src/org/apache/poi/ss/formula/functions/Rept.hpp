...
class org::apache::poi::ss::formula::functions::Rept
    : public Fixed2ArgFunction
{

public:
    typedef Fixed2ArgFunction super;
    ::org::apache::poi::ss::formula::eval::ValueEval* evaluate(int32_t srcRowIndex, int32_t srcColumnIndex, ::org::apache::poi::ss::formula::eval::ValueEval* text, ::org::apache::poi::ss::formula::eval::ValueEval* number_times) override;
