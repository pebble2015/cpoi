...
class org::apache::poi::ss::formula::functions::AggregateFunction_subtotalInstance_13
...
public:
    bool isSubtotalCounted() override;

    // Generated

public: /* protected */
    AggregateFunction_subtotalInstance_13(AggregateFunction* arg);
