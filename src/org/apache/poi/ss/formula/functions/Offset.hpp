...
class poi::ss::formula::functions::Offset final
...
private:
    static ::poi::ss::formula::eval::AreaEval* createOffset(Offset_BaseRef* baseRef, Offset_LinearOffsetRange* orRow, Offset_LinearOffsetRange* orCol) /* throws(EvaluationException) */;
    static Offset_BaseRef* evaluateBaseRef(::poi::ss::formula::eval::ValueEval* eval) /* throws(EvaluationException) */;

public: /* package */
    static int32_t evaluateIntArg(::poi::ss::formula::eval::ValueEval* eval, int32_t srcCellRow, int32_t srcCellCol) /* throws(EvaluationException) */;
