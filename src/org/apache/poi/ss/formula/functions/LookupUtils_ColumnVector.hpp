...
class poi::ss::formula::functions::LookupUtils_ColumnVector final
...
protected:
    void ctor(::poi::ss::formula::TwoDEval* tableArray_, int32_t columnIndex);
...
public:
    ...
    // Generated
    LookupUtils_ColumnVector(::poi::ss::formula::TwoDEval* tableArray_, int32_t columnIndex);
protected:
