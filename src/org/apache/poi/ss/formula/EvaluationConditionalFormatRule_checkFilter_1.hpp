...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_checkFilter_1
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_checkFilter_1(EvaluationConditionalFormatRule *EvaluationConditionalFormatRule_this);
