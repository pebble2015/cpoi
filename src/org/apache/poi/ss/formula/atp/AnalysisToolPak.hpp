...
class poi::ss::formula::atp::AnalysisToolPak final
    : public virtual ::java::lang::Object
    , public ::poi::ss::formula::udf::UDFFinder
{
...
private:
    static ::poi::ss::formula::udf::UDFFinder* instance_;
...
private:
    ...
    static void r(::java::util::Map* m, ::java::lang::String* functionName, ::poi::ss::formula::functions::FreeRefFunction* pFunc);
...
public:
    static ::poi::ss::formula::udf::UDFFinder*& instance();
