...
class org::apache::poi::ss::formula::atp::YearFrac final
...
private:
    static double evaluateDateArg(::org::apache::poi::ss::formula::eval::ValueEval* arg, int32_t srcCellRow, int32_t srcCellCol) /* throws(EvaluationException) */;
