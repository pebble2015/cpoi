...
class org::apache::poi::ss::formula::ptg::GreaterThanPtg final
    : public ValueOperatorPtg
{

public:
    typedef ValueOperatorPtg super;
    static constexpr int8_t sid { int8_t(13) };

private:
    static ::java::lang::String* GREATERTHAN_;
...
private:
    GreaterThanPtg();
protected:
    GreaterThanPtg(const ::default_init_tag&);
