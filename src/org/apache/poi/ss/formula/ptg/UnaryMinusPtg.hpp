...
class org::apache::poi::ss::formula::ptg::UnaryMinusPtg final
    : public ValueOperatorPtg
{

public:
    typedef ValueOperatorPtg super;
    static constexpr int8_t sid { int8_t(19) };

private:
    static ::java::lang::String* MINUS_;
...
private:
    UnaryMinusPtg();
protected:
    UnaryMinusPtg(const ::default_init_tag&);
