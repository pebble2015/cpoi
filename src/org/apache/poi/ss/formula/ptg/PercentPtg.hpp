...
class org::apache::poi::ss::formula::ptg::PercentPtg final
...
public:
    ...
    static constexpr int8_t sid { int8_t(20) };

private:
    static ::java::lang::String* PERCENT_;
...
private:
    PercentPtg();
protected:
    PercentPtg(const ::default_init_tag&);
