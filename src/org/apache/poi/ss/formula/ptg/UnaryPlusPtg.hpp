...
class org::apache::poi::ss::formula::ptg::UnaryPlusPtg final
    : public ValueOperatorPtg
{

public:
    typedef ValueOperatorPtg super;
    static constexpr int8_t sid { int8_t(18) };

private:
    static ::java::lang::String* ADD_;
...
private:
    UnaryPlusPtg();
protected:
    UnaryPlusPtg(const ::default_init_tag&);
