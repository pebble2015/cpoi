...
class poi::ss::formula::ptg::Area3DPtg final
    : public AreaPtgBase
...
protected:
    ...
    void ctor(::poi::ss::util::AreaReference* arearef, int32_t externIdx);
...
public:
    ...
    Area3DPtg(::poi::util::LittleEndianInput* in);
    ...
    Area3DPtg(::poi::ss::util::AreaReference* arearef, int32_t externIdx);
protected:
