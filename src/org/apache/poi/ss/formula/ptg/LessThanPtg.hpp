...
class org::apache::poi::ss::formula::ptg::LessThanPtg final
    : public ValueOperatorPtg
{

public:
    typedef ValueOperatorPtg super;
    static constexpr int8_t sid { int8_t(9) };

private:
    static ::java::lang::String* LESSTHAN_;
...
private:
    LessThanPtg();
protected:
    LessThanPtg(const ::default_init_tag&);
