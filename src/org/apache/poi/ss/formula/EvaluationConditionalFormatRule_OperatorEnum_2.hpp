...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_OperatorEnum_2 final
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_OperatorEnum_2(::java::lang::String* name, int ordinal);
