...
class org::apache::poi::ss::formula::DataValidationEvaluator_ValidationEnum_1 final
...
public:
    ...
    // Generated
    DataValidationEvaluator_ValidationEnum_1(::java::lang::String* name, int ordinal);
