...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_OperatorEnum_1 final
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_OperatorEnum_1(::java::lang::String* name, int ordinal);
