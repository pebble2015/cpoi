...
struct poi::ss::formula::IEvaluationListener
    : public virtual ::java::lang::Object
{
    virtual void onCacheHit(int32_t sheetIndex, int32_t rowIndex, int32_t columnIndex, ::poi::ss::formula::eval::ValueEval* result) = 0;
    ...
    virtual void onEndEvaluate(IEvaluationListener_ICacheEntry* entry, ::poi::ss::formula::eval::ValueEval* result) = 0;
