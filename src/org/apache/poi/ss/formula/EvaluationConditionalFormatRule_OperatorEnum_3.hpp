...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_OperatorEnum_3 final
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_OperatorEnum_3(::java::lang::String* name, int ordinal);
