...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_OperatorEnum_5 final
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_OperatorEnum_5(::java::lang::String* name, int ordinal);
