...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_OperatorEnum_7 final
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_OperatorEnum_7(::java::lang::String* name, int ordinal);
