...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_checkFilter_3
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_checkFilter_3(EvaluationConditionalFormatRule *EvaluationConditionalFormatRule_this);
