...
class org::apache::poi::ss::formula::DataValidationEvaluator_ValidationEnum_3 final
...
public:
    ...
    // Generated
    DataValidationEvaluator_ValidationEnum_3(::java::lang::String* name, int ordinal);
