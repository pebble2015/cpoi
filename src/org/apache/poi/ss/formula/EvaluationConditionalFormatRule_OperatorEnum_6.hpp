...
class org::apache::poi::ss::formula::EvaluationConditionalFormatRule_OperatorEnum_6 final
...
public:
    ...
    // Generated
    EvaluationConditionalFormatRule_OperatorEnum_6(::java::lang::String* name, int ordinal);
