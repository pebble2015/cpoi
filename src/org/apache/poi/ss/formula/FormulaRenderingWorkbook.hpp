...
struct poi::ss::formula::FormulaRenderingWorkbook
    : public virtual ::java::lang::Object
{
    ...
    virtual ::java::lang::String* resolveNameXText(::poi::ss::formula::ptg::NameXPtg* nameXPtg) = 0;
    virtual ::java::lang::String* getNameText(::poi::ss::formula::ptg::NamePtg* namePtg) = 0;
