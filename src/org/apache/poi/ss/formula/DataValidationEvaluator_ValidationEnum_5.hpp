...
class org::apache::poi::ss::formula::DataValidationEvaluator_ValidationEnum_5 final
...
public:
    ...
    // Generated
    DataValidationEvaluator_ValidationEnum_5(::java::lang::String* name, int ordinal);
