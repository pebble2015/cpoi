...
poi::ss::util::SSCellRange::SSCellRange(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ss::util::SSCellRange::SSCellRange(int32_t firstRow, int32_t firstColumn, int32_t height, int32_t width, ::poi::ss::usermodel::CellArray* flattenedArray_) 
    : SSCellRange(*static_cast< ::default_init_tag* >(0))
{
    ctor(firstRow,firstColumn,height,width,flattenedArray_);
}

void poi::ss::util::SSCellRange::ctor(int32_t firstRow, int32_t firstColumn, int32_t height, int32_t width, ::poi::ss::usermodel::CellArray* flattenedArray_)
{
    super::ctor();
    _firstRow = firstRow;
    ...
    _height = height;
    _width = width;
    _flattenedArray_ = java_cast< ::poi::ss::usermodel::CellArray* >(npc(flattenedArray_)->clone());
}

/* <B extends Cell> */poi::ss::util::SSCellRange* poi::ss::util::SSCellRange::create(int32_t firstRow, int32_t firstColumn, int32_t height, int32_t width, ::java::util::List* flattenedList, ::java::lang::Class* cellClass)
{
    clinit();
    ...
    auto flattenedArray_ = java_cast< ::poi::ss::usermodel::CellArray* >(::java::lang::reflect::Array_::newInstance(static_cast< ::java::lang::Class* >(cellClass), nItems));
...
int32_t poi::ss::util::SSCellRange::getHeight()
{
    return _height;
}

int32_t poi::ss::util::SSCellRange::getWidth()
{
    return _width;
}

int32_t poi::ss::util::SSCellRange::size()
{
    return _height * _width;
}

java::lang::String* poi::ss::util::SSCellRange::getReferenceText()
{
...
poi::ss::usermodel::Cell* poi::ss::util::SSCellRange::getTopLeftCell()
{
    return (*_flattenedArray_)[int32_t(0)];
}

poi::ss::usermodel::Cell* poi::ss::util::SSCellRange::getCell(int32_t relativeRowIndex, int32_t relativeColumnIndex)
{
...
poi::ss::usermodel::CellArray* poi::ss::util::SSCellRange::getFlattenedCells()
{
    return java_cast< ::poi::ss::usermodel::CellArray* >(npc(_flattenedArray_)->clone());
}

poi::ss::usermodel::CellArrayArray* poi::ss::util::SSCellRange::getCells()
{
    auto itemCls = npc(_flattenedArray_)->getClass();
    auto result = java_cast< ::poi::ss::usermodel::CellArrayArray* >(::java::lang::reflect::Array_::newInstance(static_cast< ::java::lang::Class* >(itemCls), _height));
    itemCls = npc(itemCls)->getComponentType();
    for (auto r = _height - int32_t(1); r >= 0; r--) {
        auto row = java_cast< ::poi::ss::usermodel::CellArray* >(::java::lang::reflect::Array_::newInstance(static_cast< ::java::lang::Class* >(itemCls), _width));
...
java::util::Iterator* poi::ss::util::SSCellRange::iterator()
{
...
java::lang::Class* poi::ss::util::SSCellRange::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ss.util.SSCellRange", 34);
    return c;
}

java::lang::Class* poi::ss::util::SSCellRange::getClass0()
{
    return class_();
}
