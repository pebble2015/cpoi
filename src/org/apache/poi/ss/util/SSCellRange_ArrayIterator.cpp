...
poi::ss::util::SSCellRange_ArrayIterator::SSCellRange_ArrayIterator(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ss::util::SSCellRange_ArrayIterator::SSCellRange_ArrayIterator(::java::lang::ObjectArray* array) 
    : SSCellRange_ArrayIterator(*static_cast< ::default_init_tag* >(0))
{
    ctor(array);
}

void poi::ss::util::SSCellRange_ArrayIterator::ctor(::java::lang::ObjectArray* array)
{
    super::ctor();
...
bool poi::ss::util::SSCellRange_ArrayIterator::hasNext()
{
    return _index < npc(_array)->length;
}

java::lang::Object* poi::ss::util::SSCellRange_ArrayIterator::next()
{
...
void poi::ss::util::SSCellRange_ArrayIterator::remove()
{
...
java::lang::Class* poi::ss::util::SSCellRange_ArrayIterator::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ss.util.SSCellRange.ArrayIterator", 48);
    return c;
}

java::lang::Class* poi::ss::util::SSCellRange_ArrayIterator::getClass0()
{
    return class_();
}
