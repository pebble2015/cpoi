...
poi::ss::util::CellUtil::CellUtil(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ss::util::CellUtil::CellUtil() 
    : CellUtil(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

poi::util::POILogger*& poi::ss::util::CellUtil::log()
{
    clinit();
    return log_;
}
poi::util::POILogger* poi::ss::util::CellUtil::log_;

java::lang::String*& poi::ss::util::CellUtil::ALIGNMENT()
{
    clinit();
    return ALIGNMENT_;
}
java::lang::String* poi::ss::util::CellUtil::ALIGNMENT_;

java::lang::String*& poi::ss::util::CellUtil::BORDER_BOTTOM()
{
    clinit();
    return BORDER_BOTTOM_;
}
java::lang::String* poi::ss::util::CellUtil::BORDER_BOTTOM_;

java::lang::String*& poi::ss::util::CellUtil::BORDER_LEFT()
{
    clinit();
    return BORDER_LEFT_;
}
java::lang::String* poi::ss::util::CellUtil::BORDER_LEFT_;

java::lang::String*& poi::ss::util::CellUtil::BORDER_RIGHT()
{
    clinit();
    return BORDER_RIGHT_;
}
java::lang::String* poi::ss::util::CellUtil::BORDER_RIGHT_;

java::lang::String*& poi::ss::util::CellUtil::BORDER_TOP()
{
    clinit();
    return BORDER_TOP_;
}
java::lang::String* poi::ss::util::CellUtil::BORDER_TOP_;

java::lang::String*& poi::ss::util::CellUtil::BOTTOM_BORDER_COLOR()
{
    clinit();
    return BOTTOM_BORDER_COLOR_;
}
java::lang::String* poi::ss::util::CellUtil::BOTTOM_BORDER_COLOR_;

java::lang::String*& poi::ss::util::CellUtil::LEFT_BORDER_COLOR()
{
    clinit();
    return LEFT_BORDER_COLOR_;
}
java::lang::String* poi::ss::util::CellUtil::LEFT_BORDER_COLOR_;

java::lang::String*& poi::ss::util::CellUtil::RIGHT_BORDER_COLOR()
{
    clinit();
    return RIGHT_BORDER_COLOR_;
}
java::lang::String* poi::ss::util::CellUtil::RIGHT_BORDER_COLOR_;

java::lang::String*& poi::ss::util::CellUtil::TOP_BORDER_COLOR()
{
    clinit();
    return TOP_BORDER_COLOR_;
}
java::lang::String* poi::ss::util::CellUtil::TOP_BORDER_COLOR_;

java::lang::String*& poi::ss::util::CellUtil::DATA_FORMAT()
{
    clinit();
    return DATA_FORMAT_;
}
java::lang::String* poi::ss::util::CellUtil::DATA_FORMAT_;

java::lang::String*& poi::ss::util::CellUtil::FILL_BACKGROUND_COLOR()
{
    clinit();
    return FILL_BACKGROUND_COLOR_;
}
java::lang::String* poi::ss::util::CellUtil::FILL_BACKGROUND_COLOR_;

java::lang::String*& poi::ss::util::CellUtil::FILL_FOREGROUND_COLOR()
{
    clinit();
    return FILL_FOREGROUND_COLOR_;
}
java::lang::String* poi::ss::util::CellUtil::FILL_FOREGROUND_COLOR_;

java::lang::String*& poi::ss::util::CellUtil::FILL_PATTERN()
{
    clinit();
    return FILL_PATTERN_;
}
java::lang::String* poi::ss::util::CellUtil::FILL_PATTERN_;

java::lang::String*& poi::ss::util::CellUtil::FONT()
{
    clinit();
    return FONT_;
}
java::lang::String* poi::ss::util::CellUtil::FONT_;

java::lang::String*& poi::ss::util::CellUtil::HIDDEN()
{
    clinit();
    return HIDDEN_;
}
java::lang::String* poi::ss::util::CellUtil::HIDDEN_;

java::lang::String*& poi::ss::util::CellUtil::INDENTION()
{
    clinit();
    return INDENTION_;
}
java::lang::String* poi::ss::util::CellUtil::INDENTION_;

java::lang::String*& poi::ss::util::CellUtil::LOCKED()
{
    clinit();
    return LOCKED_;
}
java::lang::String* poi::ss::util::CellUtil::LOCKED_;

java::lang::String*& poi::ss::util::CellUtil::ROTATION()
{
    clinit();
    return ROTATION_;
}
java::lang::String* poi::ss::util::CellUtil::ROTATION_;

java::lang::String*& poi::ss::util::CellUtil::VERTICAL_ALIGNMENT()
{
    clinit();
    return VERTICAL_ALIGNMENT_;
}
java::lang::String* poi::ss::util::CellUtil::VERTICAL_ALIGNMENT_;

java::lang::String*& poi::ss::util::CellUtil::WRAP_TEXT()
{
    clinit();
    return WRAP_TEXT_;
}
java::lang::String* poi::ss::util::CellUtil::WRAP_TEXT_;

java::util::Set*& poi::ss::util::CellUtil::shortValues()
{
    clinit();
    return shortValues_;
}
java::util::Set* poi::ss::util::CellUtil::shortValues_;

java::util::Set*& poi::ss::util::CellUtil::booleanValues()
{
    clinit();
    return booleanValues_;
}
java::util::Set* poi::ss::util::CellUtil::booleanValues_;

java::util::Set*& poi::ss::util::CellUtil::borderTypeValues()
{
    clinit();
    return borderTypeValues_;
}
java::util::Set* poi::ss::util::CellUtil::borderTypeValues_;

poi::ss::util::CellUtil_UnicodeMappingArray*& poi::ss::util::CellUtil::unicodeMappings()
{
    clinit();
    return unicodeMappings_;
}
poi::ss::util::CellUtil_UnicodeMappingArray* poi::ss::util::CellUtil::unicodeMappings_;

void poi::ss::util::CellUtil::ctor()
{
    super::ctor();
}

poi::ss::usermodel::Row* poi::ss::util::CellUtil::getRow(int32_t rowIndex, ::poi::ss::usermodel::Sheet* sheet)
{
    clinit();
...
poi::ss::usermodel::Cell* poi::ss::util::CellUtil::getCell(::poi::ss::usermodel::Row* row, int32_t columnIndex)
{
    clinit();
...
poi::ss::usermodel::Cell* poi::ss::util::CellUtil::createCell(::poi::ss::usermodel::Row* row, int32_t column, ::java::lang::String* value, ::poi::ss::usermodel::CellStyle* style)
{
    clinit();
...
poi::ss::usermodel::Cell* poi::ss::util::CellUtil::createCell(::poi::ss::usermodel::Row* row, int32_t column, ::java::lang::String* value)
{
    clinit();
    return createCell(row, column, value, nullptr);
}

void poi::ss::util::CellUtil::setAlignment(::poi::ss::usermodel::Cell* cell, ::poi::ss::usermodel::HorizontalAlignment* align)
{
    clinit();
    setCellStyleProperty(cell, ALIGNMENT_, align);
}

void poi::ss::util::CellUtil::setVerticalAlignment(::poi::ss::usermodel::Cell* cell, ::poi::ss::usermodel::VerticalAlignment* align)
{
    clinit();
    setCellStyleProperty(cell, VERTICAL_ALIGNMENT_, align);
}

void poi::ss::util::CellUtil::setFont(::poi::ss::usermodel::Cell* cell, ::poi::ss::usermodel::Font* font)
{
    clinit();
...
void poi::ss::util::CellUtil::setCellStyleProperties(::poi::ss::usermodel::Cell* cell, ::java::util::Map* properties)
{
    clinit();
    auto workbook = npc(npc(cell)->getSheet())->getWorkbook();
    auto originalStyle = npc(cell)->getCellStyle();
    ::poi::ss::usermodel::CellStyle* newStyle = nullptr;
...
void poi::ss::util::CellUtil::setCellStyleProperty(::poi::ss::usermodel::Cell* cell, ::java::lang::String* propertyName, ::java::lang::Object* propertyValue)
{
    clinit();
...
java::util::Map* poi::ss::util::CellUtil::getFormatProperties(::poi::ss::usermodel::CellStyle* style)
{
    clinit();
...
void poi::ss::util::CellUtil::putAll(::java::util::Map* src, ::java::util::Map* dest)
{
    clinit();
    for (auto _i = npc(npc(src)->keySet())->iterator(); _i->hasNext(); ) {
        ::java::lang::String* key = java_cast< ::java::lang::String* >(_i->next());
        {
            if(npc(shortValues_)->contains(static_cast< ::java::lang::Object* >(key))) {
                ...
                if(npc(log_)->check(::poi::util::POILogger::INFO)) {
                    npc(log_)->log(::poi::util::POILogger::INFO, new ::java::lang::ObjectArray({static_cast< ::java::lang::Object* >(::java::lang::StringBuilder().append(u"Ignoring unrecognized CellUtil format properties key: "_j)->append(key)->toString())}));
                }
            }
        }
    }
...
void poi::ss::util::CellUtil::setFormatProperties(::poi::ss::usermodel::CellStyle* style, ::poi::ss::usermodel::Workbook* workbook, ::java::util::Map* properties)
{
    clinit();
...
int16_t poi::ss::util::CellUtil::getShort(::java::util::Map* properties, ::java::lang::String* name)
{
    clinit();
...
poi::ss::usermodel::BorderStyle* poi::ss::util::CellUtil::getBorderStyle(::java::util::Map* properties, ::java::lang::String* name)
{
    clinit();
    auto value = java_cast< ::java::lang::Object* >(npc(properties)->get(name));
    ::poi::ss::usermodel::BorderStyle* border;
    if(dynamic_cast< ::poi::ss::usermodel::BorderStyle* >(value) != nullptr) {
        border = java_cast< ::poi::ss::usermodel::BorderStyle* >(value);
    } else if(dynamic_cast< ::java::lang::Short* >(value) != nullptr) {
        if(npc(log_)->check(::poi::util::POILogger::WARN)) {
            npc(log_)->log(::poi::util::POILogger::WARN, new ::java::lang::ObjectArray({static_cast< ::java::lang::Object* >(::java::lang::StringBuilder().append(u"Deprecation warning: CellUtil properties map uses Short values for "_j)->append(name)
                ->append(u". Should use BorderStyle enums instead."_j)->toString())}));
        }
        auto code = npc((java_cast< ::java::lang::Short* >(value)))->shortValue();
        border = ::poi::ss::usermodel::BorderStyle::valueOf(code);
    } else if(value == nullptr) {
        border = ::poi::ss::usermodel::BorderStyle::NONE;
    } else {
...
poi::ss::usermodel::FillPatternType* poi::ss::util::CellUtil::getFillPattern(::java::util::Map* properties, ::java::lang::String* name)
{
    clinit();
    auto value = java_cast< ::java::lang::Object* >(npc(properties)->get(name));
    ::poi::ss::usermodel::FillPatternType* pattern;
    if(dynamic_cast< ::poi::ss::usermodel::FillPatternType* >(value) != nullptr) {
        pattern = java_cast< ::poi::ss::usermodel::FillPatternType* >(value);
    } else if(dynamic_cast< ::java::lang::Short* >(value) != nullptr) {
        if(npc(log_)->check(::poi::util::POILogger::WARN)) {
            npc(log_)->log(::poi::util::POILogger::WARN, new ::java::lang::ObjectArray({static_cast< ::java::lang::Object* >(::java::lang::StringBuilder().append(u"Deprecation warning: CellUtil properties map uses Short values for "_j)->append(name)
        ...
        auto code = npc((java_cast< ::java::lang::Short* >(value)))->shortValue();
        pattern = ::poi::ss::usermodel::FillPatternType::forInt(code);
    } else if(value == nullptr) {
        pattern = ::poi::ss::usermodel::FillPatternType::NO_FILL;
    } else {
...
poi::ss::usermodel::HorizontalAlignment* poi::ss::util::CellUtil::getHorizontalAlignment(::java::util::Map* properties, ::java::lang::String* name)
{
    clinit();
    auto value = java_cast< ::java::lang::Object* >(npc(properties)->get(name));
    ::poi::ss::usermodel::HorizontalAlignment* align;
    if(dynamic_cast< ::poi::ss::usermodel::HorizontalAlignment* >(value) != nullptr) {
        align = java_cast< ::poi::ss::usermodel::HorizontalAlignment* >(value);
    } else if(dynamic_cast< ::java::lang::Short* >(value) != nullptr) {
        if(npc(log_)->check(::poi::util::POILogger::WARN)) {
            npc(log_)->log(::poi::util::POILogger::WARN, new ::java::lang::ObjectArray({static_cast< ::java::lang::Object* >(::java::lang::StringBuilder().append(u"Deprecation warning: CellUtil properties map used a Short value for "_j)->append(name)
                ->append(u". Should use HorizontalAlignment enums instead."_j)->toString())}));
        }
        auto code = npc((java_cast< ::java::lang::Short* >(value)))->shortValue();
        align = ::poi::ss::usermodel::HorizontalAlignment::forInt(code);
    } else if(value == nullptr) {
        align = ::poi::ss::usermodel::HorizontalAlignment::GENERAL;
    } else {
...
poi::ss::usermodel::VerticalAlignment* poi::ss::util::CellUtil::getVerticalAlignment(::java::util::Map* properties, ::java::lang::String* name)
{
    clinit();
    auto value = java_cast< ::java::lang::Object* >(npc(properties)->get(name));
    ::poi::ss::usermodel::VerticalAlignment* align;
    if(dynamic_cast< ::poi::ss::usermodel::VerticalAlignment* >(value) != nullptr) {
        align = java_cast< ::poi::ss::usermodel::VerticalAlignment* >(value);
    } else if(dynamic_cast< ::java::lang::Short* >(value) != nullptr) {
        if(npc(log_)->check(::poi::util::POILogger::WARN)) {
            npc(log_)->log(::poi::util::POILogger::WARN, new ::java::lang::ObjectArray({static_cast< ::java::lang::Object* >(::java::lang::StringBuilder().append(u"Deprecation warning: CellUtil properties map used a Short value for "_j)->append(name)
        ...
        auto code = npc((java_cast< ::java::lang::Short* >(value)))->shortValue();
        align = ::poi::ss::usermodel::VerticalAlignment::forInt(code);
    } else if(value == nullptr) {
        align = ::poi::ss::usermodel::VerticalAlignment::BOTTOM;
    } else {
...
bool poi::ss::util::CellUtil::getBoolean(::java::util::Map* properties, ::java::lang::String* name)
{
    clinit();
    auto value = java_cast< ::java::lang::Object* >(npc(properties)->get(name));
...
void poi::ss::util::CellUtil::put(::java::util::Map* properties, ::java::lang::String* name, ::java::lang::Object* value)
{
    clinit();
    npc(properties)->put(name, value);
}

poi::ss::usermodel::Cell* poi::ss::util::CellUtil::translateUnicodeValues(::poi::ss::usermodel::Cell* cell)
{
    clinit();
...
poi::ss::util::CellUtil_UnicodeMapping* poi::ss::util::CellUtil::um(::java::lang::String* entityName, ::java::lang::String* resolvedValue)
{
    clinit();
...
java::lang::Class* poi::ss::util::CellUtil::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ss.util.CellUtil", 31);
    return c;
}

void poi::ss::util::CellUtil::clinit()
{
struct string_init_ {
    string_init_() {
...
struct clinit_ {
    clinit_() {
        in_cl_init = true;
        log_ = ::poi::util::POILogFactory::getLogger(static_cast< ::java::lang::Class* >(CellUtil::class_()));
...
java::lang::Class* poi::ss::util::CellUtil::getClass0()
{
    return class_();
}
