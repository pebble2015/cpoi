...
poi::hpsf::Decimal::Decimal(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::hpsf::Decimal::Decimal() 
    : Decimal(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void poi::hpsf::Decimal::ctor()
{
    super::ctor();
}

void poi::hpsf::Decimal::read(::poi::util::LittleEndianByteArrayInputStream* lei)
{
...
java::lang::Class* poi::hpsf::Decimal::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hpsf.Decimal", 27);
    return c;
}

java::lang::Class* poi::hpsf::Decimal::getClass0()
{
    return class_();
}
