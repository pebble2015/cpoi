...
org::apache::poi::hpsf::UnsupportedVariantTypeException::UnsupportedVariantTypeException(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::apache::poi::hpsf::UnsupportedVariantTypeException::UnsupportedVariantTypeException(int64_t variantType, ::java::lang::Object* value) 
    : UnsupportedVariantTypeException(*static_cast< ::default_init_tag* >(0))
{
    ctor(variantType,value);
}

void org::apache::poi::hpsf::UnsupportedVariantTypeException::ctor(int64_t variantType, ::java::lang::Object* value)
{
...
java::lang::Class* org::apache::poi::hpsf::UnsupportedVariantTypeException::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hpsf.UnsupportedVariantTypeException", 51);
    return c;
}

java::lang::Class* org::apache::poi::hpsf::UnsupportedVariantTypeException::getClass0()
{
    return class_();
}
