...
class org::apache::poi::hpsf::MutableProperty
    : public Property
{
...
public:
    ...
    MutableProperty(int64_t id, ::org::apache::poi::util::LittleEndianByteArrayInputStream* leis, int32_t length, int32_t codepage);
protected:
