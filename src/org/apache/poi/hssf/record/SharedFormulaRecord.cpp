...
poi::hssf::record::SharedFormulaRecord::SharedFormulaRecord(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::hssf::record::SharedFormulaRecord::SharedFormulaRecord() 
    : SharedFormulaRecord(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

poi::hssf::record::SharedFormulaRecord::SharedFormulaRecord(::poi::hssf::util::CellRangeAddress8Bit* range) 
    : SharedFormulaRecord(*static_cast< ::default_init_tag* >(0))
{
    ctor(range);
}

poi::hssf::record::SharedFormulaRecord::SharedFormulaRecord(RecordInputStream* in) 
    : SharedFormulaRecord(*static_cast< ::default_init_tag* >(0))
{
    ctor(in);
}

constexpr int16_t poi::hssf::record::SharedFormulaRecord::sid;

void poi::hssf::record::SharedFormulaRecord::ctor()
{
    ctor(new ::poi::hssf::util::CellRangeAddress8Bit(int32_t(0), int32_t(0), int32_t(0), int32_t(0)));
}

void poi::hssf::record::SharedFormulaRecord::ctor(::poi::hssf::util::CellRangeAddress8Bit* range)
{
    super::ctor(range);
    field_7_parsed_expr = ::poi::ss::formula::Formula::create(::poi::ss::formula::ptg::Ptg::EMPTY_PTG_ARRAY());
}

void poi::hssf::record::SharedFormulaRecord::ctor(RecordInputStream* in)
{
    ...
    field_7_parsed_expr = ::poi::ss::formula::Formula::read(field_6_expression_len, in, nAvailableBytes);
}

void poi::hssf::record::SharedFormulaRecord::serializeExtraData(::poi::util::LittleEndianOutput* out)
{
    npc(out)->writeShort(field_5_reserved);
    npc(field_7_parsed_expr)->serialize(out);
}

int32_t poi::hssf::record::SharedFormulaRecord::getExtraDataSize()
{
    return int32_t(2) + npc(field_7_parsed_expr)->getEncodedSize();
}

java::lang::String* poi::hssf::record::SharedFormulaRecord::toString()
{
    auto buffer = new ::java::lang::StringBuffer();
    npc(npc(npc(buffer)->append(u"[SHARED FORMULA ("_j))->append(::poi::util::HexDump::intToHex(sid)))->append(u"]\n"_j);
    npc(npc(npc(buffer)->append(u"    .range      = "_j))->append(static_cast< ::java::lang::Object* >(getRange())))->append(u"\n"_j);
    npc(npc(npc(buffer)->append(u"    .reserved    = "_j))->append(::poi::util::HexDump::shortToHex(field_5_reserved)))->append(u"\n"_j);
...
int16_t poi::hssf::record::SharedFormulaRecord::getSid()
{
    return sid;
}

poi::ss::formula::ptg::PtgArray* poi::hssf::record::SharedFormulaRecord::getFormulaTokens(FormulaRecord* formula)
{
    ...
    auto sf = new ::poi::ss::formula::SharedFormula(::poi::ss::SpreadsheetVersion::EXCEL97);
    return npc(sf)->convertSharedFormulas(npc(field_7_parsed_expr)->getTokens(), formulaRow, formulaColumn);
}

java::lang::Object* poi::hssf::record::SharedFormulaRecord::clone()
{
...
bool poi::hssf::record::SharedFormulaRecord::isFormulaSame(SharedFormulaRecord* other)
{
...
java::lang::Class* poi::hssf::record::SharedFormulaRecord::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.record.SharedFormulaRecord", 46);
    return c;
}

java::lang::Class* poi::hssf::record::SharedFormulaRecord::getClass0()
{
    return class_();
}
