...
poi::hssf::record::SSTSerializer::SSTSerializer(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::hssf::record::SSTSerializer::SSTSerializer(::poi::util::IntMapper* strings, int32_t numStrings, int32_t numUniqueStrings) 
    : SSTSerializer(*static_cast< ::default_init_tag* >(0))
{
    ctor(strings,numStrings,numUniqueStrings);
}

void poi::hssf::record::SSTSerializer::ctor(::poi::util::IntMapper* strings, int32_t numStrings, int32_t numUniqueStrings)
{
    super::ctor();
...
void poi::hssf::record::SSTSerializer::serialize(::poi::hssf::record::cont::ContinuableRecordOutput* out)
{
...
poi::hssf::record::common::UnicodeString* poi::hssf::record::SSTSerializer::getUnicodeString(int32_t index)
{
    return getUnicodeString(strings, index);
}

poi::hssf::record::common::UnicodeString* poi::hssf::record::SSTSerializer::getUnicodeString(::poi::util::IntMapper* strings, int32_t index)
{
    clinit();
    return (java_cast< ::poi::hssf::record::common::UnicodeString* >(npc(strings)->get(index)));
}

int32_tArray* poi::hssf::record::SSTSerializer::getBucketAbsoluteOffsets()
{
    return bucketAbsoluteOffsets;
}

int32_tArray* poi::hssf::record::SSTSerializer::getBucketRelativeOffsets()
{
...
java::lang::Class* poi::hssf::record::SSTSerializer::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.record.SSTSerializer", 40);
    return c;
}

java::lang::Class* poi::hssf::record::SSTSerializer::getClass0()
{
    return class_();
}
