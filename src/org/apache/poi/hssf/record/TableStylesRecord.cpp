...
poi::hssf::record::TableStylesRecord::TableStylesRecord(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::hssf::record::TableStylesRecord::TableStylesRecord(RecordInputStream* in) 
    : TableStylesRecord(*static_cast< ::default_init_tag* >(0))
{
    ctor(in);
}

void poi::hssf::record::TableStylesRecord::init()
{
    unused = new ::int8_tArray(int32_t(8));
}

constexpr int16_t poi::hssf::record::TableStylesRecord::sid;

void poi::hssf::record::TableStylesRecord::ctor(RecordInputStream* in)
{
    super::ctor();
    init();
...
void poi::hssf::record::TableStylesRecord::serialize(::poi::util::LittleEndianOutput* out)
{
    ...
    ::poi::util::StringUtil::putUnicodeLE(rgchDefListStyle, out);
    ::poi::util::StringUtil::putUnicodeLE(rgchDefPivotStyle, out);
}

int32_t poi::hssf::record::TableStylesRecord::getDataSize()
{
...
int16_t poi::hssf::record::TableStylesRecord::getSid()
{
    return sid;
}

java::lang::String* poi::hssf::record::TableStylesRecord::toString()
{
    ...
    npc(npc(npc(buffer)->append(u"    .cts="_j))->append(::poi::util::HexDump::intToHex(cts)))->append(u'\u000a');
...
java::lang::Class* poi::hssf::record::TableStylesRecord::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.record.TableStylesRecord", 44);
    return c;
}

int32_t poi::hssf::record::TableStylesRecord::serialize(int32_t offset, ::int8_tArray* data)
{
    return super::serialize(offset, data);
}

int8_tArray* poi::hssf::record::TableStylesRecord::serialize()
{
    return super::serialize();
}

java::lang::Class* poi::hssf::record::TableStylesRecord::getClass0()
{
    return class_();
}
