...
poi::hssf::record::FormatRecord::FormatRecord(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::hssf::record::FormatRecord::FormatRecord(FormatRecord* other) 
    : FormatRecord(*static_cast< ::default_init_tag* >(0))
{
    ctor(other);
}

poi::hssf::record::FormatRecord::FormatRecord(int32_t indexCode, ::java::lang::String* fs) 
    : FormatRecord(*static_cast< ::default_init_tag* >(0))
{
    ctor(indexCode,fs);
}

poi::hssf::record::FormatRecord::FormatRecord(RecordInputStream* in) 
    : FormatRecord(*static_cast< ::default_init_tag* >(0))
{
    ctor(in);
}

poi::util::POILogger*& poi::hssf::record::FormatRecord::logger()
{
    clinit();
    return logger_;
}
poi::util::POILogger* poi::hssf::record::FormatRecord::logger_;

constexpr int16_t poi::hssf::record::FormatRecord::sid;

void poi::hssf::record::FormatRecord::ctor(FormatRecord* other)
{
    super::ctor();
...
void poi::hssf::record::FormatRecord::ctor(int32_t indexCode, ::java::lang::String* fs)
{
    super::ctor();
    field_1_index_code = indexCode;
    field_4_formatstring = fs;
    field_3_hasMultibyte = ::poi::util::StringUtil::hasMultibyte(fs);
}

void poi::hssf::record::FormatRecord::ctor(RecordInputStream* in)
{
    super::ctor();
...
int32_t poi::hssf::record::FormatRecord::getIndexCode()
{
    return field_1_index_code;
}

java::lang::String* poi::hssf::record::FormatRecord::getFormatString()
{
    return field_4_formatstring;
}

java::lang::String* poi::hssf::record::FormatRecord::toString()
{
    auto buffer = new ::java::lang::StringBuffer();
    npc(buffer)->append(u"[FORMAT]\n"_j);
    npc(npc(npc(buffer)->append(u"    .indexcode       = "_j))->append(::poi::util::HexDump::shortToHex(getIndexCode())))->append(u"\n"_j);
...
void poi::hssf::record::FormatRecord::serialize(::poi::util::LittleEndianOutput* out)
{
    ...
    if(field_3_hasMultibyte) {
        ::poi::util::StringUtil::putUnicodeLE(formatString, out);
    } else {
        ::poi::util::StringUtil::putCompressedUnicode(formatString, out);
    }
}

int32_t poi::hssf::record::FormatRecord::getDataSize()
{
    return int32_t(5) + npc(getFormatString())->length() * (field_3_hasMultibyte ? int32_t(2) : int32_t(1));
}

int16_t poi::hssf::record::FormatRecord::getSid()
{
    return sid;
}

poi::hssf::record::FormatRecord* poi::hssf::record::FormatRecord::clone()
{
    return new FormatRecord(this);
}

java::lang::String* poi::hssf::record::FormatRecord::readStringCommon(RecordInputStream* ris, int32_t requestedLength, bool pIsCompressedEncoding)
{
    clinit();
    ...
    auto availableChars = isCompressedEncoding ? npc(ris)->remaining() : npc(ris)->remaining() / ::poi::util::LittleEndianConsts::SHORT_SIZE;
    ...
    if(npc(ris)->available() > 0) {
        npc(logger_)->log(::poi::util::POILogger::INFO, new ::java::lang::ObjectArray({static_cast< ::java::lang::Object* >(::java::lang::StringBuilder().append(u"FormatRecord has "_j)->append(npc(ris)->available())
...
java::lang::Class* poi::hssf::record::FormatRecord::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.record.FormatRecord", 39);
    return c;
}

void poi::hssf::record::FormatRecord::clinit()
{
    super::clinit();
...
struct clinit_ {
    clinit_() {
        in_cl_init = true;
        logger_ = ::poi::util::POILogFactory::getLogger(static_cast< ::java::lang::Class* >(FormatRecord::class_()));
    }
};
...
int32_t poi::hssf::record::FormatRecord::serialize(int32_t offset, ::int8_tArray* data)
{
    return super::serialize(offset, data);
}

int8_tArray* poi::hssf::record::FormatRecord::serialize()
{
    return super::serialize();
}

java::lang::Class* poi::hssf::record::FormatRecord::getClass0()
{
    return class_();
}
