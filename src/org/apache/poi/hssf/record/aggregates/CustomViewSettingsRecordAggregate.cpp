...
poi::hssf::record::aggregates::CustomViewSettingsRecordAggregate::CustomViewSettingsRecordAggregate(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::hssf::record::aggregates::CustomViewSettingsRecordAggregate::CustomViewSettingsRecordAggregate(::poi::hssf::model::RecordStream* rs) 
    : CustomViewSettingsRecordAggregate(*static_cast< ::default_init_tag* >(0))
{
    ctor(rs);
}

void poi::hssf::record::aggregates::CustomViewSettingsRecordAggregate::ctor(::poi::hssf::model::RecordStream* rs)
{
    super::ctor();
    _begin = npc(rs)->getNext();
    if(npc(_begin)->getSid() != ::poi::hssf::record::UserSViewBegin::sid) {
        throw new ::java::lang::IllegalStateException(u"Bad begin record"_j);
    }
    ::java::util::List* temp = new ::java::util::ArrayList();
    while (npc(rs)->peekNextSid() != ::poi::hssf::record::UserSViewEnd::sid) {
    ...
    _recs = temp;
    _end = npc(rs)->getNext();
    if(npc(_end)->getSid() != ::poi::hssf::record::UserSViewEnd::sid) {
        throw new ::java::lang::IllegalStateException(u"Bad custom view settings end record"_j);
    }
}

void poi::hssf::record::aggregates::CustomViewSettingsRecordAggregate::visitContainedRecords(RecordAggregate_RecordVisitor* rv)
{
...
bool poi::hssf::record::aggregates::CustomViewSettingsRecordAggregate::isBeginRecord(int32_t sid)
{
    clinit();
    return sid == ::poi::hssf::record::UserSViewBegin::sid;
}

void poi::hssf::record::aggregates::CustomViewSettingsRecordAggregate::append(::poi::hssf::record::RecordBase* r)
{
...
java::lang::Class* poi::hssf::record::aggregates::CustomViewSettingsRecordAggregate::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.record.aggregates.CustomViewSettingsRecordAggregate", 71);
    return c;
}

java::lang::Class* poi::hssf::record::aggregates::CustomViewSettingsRecordAggregate::getClass0()
{
    return class_();
}
