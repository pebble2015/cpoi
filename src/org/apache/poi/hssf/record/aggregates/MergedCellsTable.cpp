...
poi::hssf::record::aggregates::MergedCellsTable::MergedCellsTable(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::hssf::record::aggregates::MergedCellsTable::MergedCellsTable() 
    : MergedCellsTable(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

int32_t& poi::hssf::record::aggregates::MergedCellsTable::MAX_MERGED_REGIONS()
{
    clinit();
    return MAX_MERGED_REGIONS_;
}
int32_t poi::hssf::record::aggregates::MergedCellsTable::MAX_MERGED_REGIONS_;

void poi::hssf::record::aggregates::MergedCellsTable::ctor()
{
    super::ctor();
    _mergedRegions = new ::java::util::ArrayList();
}

void poi::hssf::record::aggregates::MergedCellsTable::read(::poi::hssf::model::RecordStream* rs)
{
    auto temp = _mergedRegions;
    while (static_cast< ::java::lang::Object* >(npc(rs)->peekNextClass()) == static_cast< ::java::lang::Object* >(::poi::hssf::record::MergeCellsRecord::class_())) {
        auto mcr = java_cast< ::poi::hssf::record::MergeCellsRecord* >(npc(rs)->getNext());
...
int32_t poi::hssf::record::aggregates::MergedCellsTable::getRecordSize()
{
    ...
    auto result = nMergedCellsRecords * (int32_t(4) + ::poi::ss::util::CellRangeAddressList::getEncodedSize(MAX_MERGED_REGIONS_)) + int32_t(4) + ::poi::ss::util::CellRangeAddressList::getEncodedSize(nLeftoverMergedRegions);
    return result;
}

void poi::hssf::record::aggregates::MergedCellsTable::visitContainedRecords(RecordAggregate_RecordVisitor* rv)
{
    auto nRegions = npc(_mergedRegions)->size();
    if(nRegions < 1) {
        return;
    ...
    for (auto i = int32_t(0); i < nFullMergedCellsRecords; i++) {
        ...
        npc(rv)->visitRecord(new ::poi::hssf::record::MergeCellsRecord(cras, startIx, MAX_MERGED_REGIONS_));
    }
    if(nLeftoverMergedRegions > 0) {
        auto startIx = nFullMergedCellsRecords * MAX_MERGED_REGIONS_;
        npc(rv)->visitRecord(new ::poi::hssf::record::MergeCellsRecord(cras, startIx, nLeftoverMergedRegions));
    }
}

void poi::hssf::record::aggregates::MergedCellsTable::addRecords(::poi::hssf::record::MergeCellsRecordArray* mcrs)
{
...
void poi::hssf::record::aggregates::MergedCellsTable::addMergeCellsRecord(::poi::hssf::record::MergeCellsRecord* mcr)
{
    int32_t nRegions = npc(mcr)->getNumAreas();
    for (auto i = int32_t(0); i < nRegions; i++) {
        auto cra = npc(mcr)->getAreaAt(i);
...
poi::ss::util::CellRangeAddress* poi::hssf::record::aggregates::MergedCellsTable::get(int32_t index)
{
    checkIndex(index);
    return java_cast< ::poi::ss::util::CellRangeAddress* >(npc(_mergedRegions)->get(index));
}

void poi::hssf::record::aggregates::MergedCellsTable::remove(int32_t index)
{
    checkIndex(index);
    npc(_mergedRegions)->remove(index);
}

void poi::hssf::record::aggregates::MergedCellsTable::checkIndex(int32_t index)
{
...
void poi::hssf::record::aggregates::MergedCellsTable::addArea(int32_t rowFrom, int32_t colFrom, int32_t rowTo, int32_t colTo)
{
    npc(_mergedRegions)->add(static_cast< ::java::lang::Object* >(new ::poi::ss::util::CellRangeAddress(rowFrom, rowTo, colFrom, colTo)));
}

int32_t poi::hssf::record::aggregates::MergedCellsTable::getNumberOfMergedRegions()
{
...
java::lang::Class* poi::hssf::record::aggregates::MergedCellsTable::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.record.aggregates.MergedCellsTable", 54);
    return c;
}

void poi::hssf::record::aggregates::MergedCellsTable::clinit()
{
    super::clinit();
...
java::lang::Class* poi::hssf::record::aggregates::MergedCellsTable::getClass0()
{
    return class_();
}
