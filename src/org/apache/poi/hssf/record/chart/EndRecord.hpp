...
class org::apache::poi::hssf::record::chart::EndRecord final
...
public:
    ...
    static constexpr int16_t sid { int16_t(4148) };
protected:
    void ctor();
...
public:
    ...
    EndRecord* clone() override;

    // Generated
    EndRecord();
    EndRecord(::org::apache::poi::hssf::record::RecordInputStream* in);
protected:
    EndRecord(const ::default_init_tag&);
