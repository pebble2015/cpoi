...
class org::apache::poi::hssf::util::HSSFColor_HSSFColorRef
    : public HSSFColor
{

public:
    typedef HSSFColor super;
protected:
    void ctor(HSSFColor_HSSFColorPredefined* colorEnum);

    // Generated

public: /* package */
    HSSFColor_HSSFColorRef(HSSFColor_HSSFColorPredefined* colorEnum);
protected:
    HSSFColor_HSSFColorRef(const ::default_init_tag&);
