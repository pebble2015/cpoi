...
org::apache::poi::hssf::model::RecordOrderer::RecordOrderer(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::apache::poi::hssf::model::RecordOrderer::RecordOrderer() 
    : RecordOrderer(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void org::apache::poi::hssf::model::RecordOrderer::ctor()
{
    super::ctor();
}

void org::apache::poi::hssf::model::RecordOrderer::addNewSheetRecord(::java::util::List* sheetRecords, ::org::apache::poi::hssf::record::RecordBase* newRecord)
{
    clinit();
...
int32_t org::apache::poi::hssf::model::RecordOrderer::findSheetInsertPos(::java::util::List* records, ::java::lang::Class* recClass)
{
    clinit();
    if(static_cast< ::java::lang::Object* >(recClass) == static_cast< ::java::lang::Object* >(::org::apache::poi::hssf::record::aggregates::DataValidityTable::class_())) {
        return findDataValidationTableInsertPos(records);
    }
    if(static_cast< ::java::lang::Object* >(recClass) == static_cast< ::java::lang::Object* >(::org::apache::poi::hssf::record::aggregates::MergedCellsTable::class_())) {
        return findInsertPosForNewMergedRecordTable(records);
    }
    if(static_cast< ::java::lang::Object* >(recClass) == static_cast< ::java::lang::Object* >(::org::apache::poi::hssf::record::aggregates::ConditionalFormattingTable::class_())) {
        return findInsertPosForNewCondFormatTable(records);
    }
    if(static_cast< ::java::lang::Object* >(recClass) == static_cast< ::java::lang::Object* >(::org::apache::poi::hssf::record::GutsRecord::class_())) {
        return getGutsRecordInsertPos(records);
    }
    if(static_cast< ::java::lang::Object* >(recClass) == static_cast< ::java::lang::Object* >(::org::apache::poi::hssf::record::aggregates::PageSettingsBlock::class_())) {
        return getPageBreakRecordInsertPos(records);
    }
    if(static_cast< ::java::lang::Object* >(recClass) == static_cast< ::java::lang::Object* >(::org::apache::poi::hssf::record::aggregates::WorksheetProtectionBlock::class_())) {
...
int32_t org::apache::poi::hssf::model::RecordOrderer::getWorksheetProtectionBlockInsertPos(::java::util::List* records)
{
    clinit();
    auto i = getDimensionsIndex(records);
    while (i > 0) {
        i--;
        ::java::lang::Object* rb = java_cast< ::org::apache::poi::hssf::record::RecordBase* >(npc(records)->get(i));
...
bool org::apache::poi::hssf::model::RecordOrderer::isProtectionSubsequentRecord(::java::lang::Object* rb)
{
    clinit();
    if(dynamic_cast< ::org::apache::poi::hssf::record::aggregates::ColumnInfoRecordsAggregate* >(rb) != nullptr) {
        return true;
    }
    if(dynamic_cast< ::org::apache::poi::hssf::record::Record* >(rb) != nullptr) {
        ...
        case ::org::apache::poi::hssf::record::UnknownRecord::SORT_0090:
            return true;
        }
...
int32_t org::apache::poi::hssf::model::RecordOrderer::getPageBreakRecordInsertPos(::java::util::List* records)
{
    clinit();
...
bool org::apache::poi::hssf::model::RecordOrderer::isPageBreakPriorRecord(::java::lang::Object* rb)
{
    clinit();
    if(dynamic_cast< ::org::apache::poi::hssf::record::Record* >(rb) != nullptr) {
        auto record = java_cast< ::org::apache::poi::hssf::record::Record* >(rb);
        ...
        case ::org::apache::poi::hssf::record::UnknownRecord::SHEETPR_0081:
            return true;
        }
...
int32_t org::apache::poi::hssf::model::RecordOrderer::findInsertPosForNewCondFormatTable(::java::util::List* records)
{
    clinit();
    for (auto i = npc(records)->size() - int32_t(2); i >= 0; i--) {
        ::java::lang::Object* rb = java_cast< ::org::apache::poi::hssf::record::RecordBase* >(npc(records)->get(i));
        if(dynamic_cast< ::org::apache::poi::hssf::record::aggregates::MergedCellsTable* >(rb) != nullptr) {
            return i + int32_t(1);
        }
        if(dynamic_cast< ::org::apache::poi::hssf::record::aggregates::DataValidityTable* >(rb) != nullptr) {
            continue;
        }
        auto rec = java_cast< ::org::apache::poi::hssf::record::Record* >(rb);
        ...
        case ::org::apache::poi::hssf::record::UnknownRecord::STANDARDWIDTH_0099:
        case ::org::apache::poi::hssf::record::UnknownRecord::LABELRANGES_015F:
        case ::org::apache::poi::hssf::record::UnknownRecord::PHONETICPR_00EF:
            return i + int32_t(1);
        }
...
int32_t org::apache::poi::hssf::model::RecordOrderer::findInsertPosForNewMergedRecordTable(::java::util::List* records)
{
    clinit();
    for (auto i = npc(records)->size() - int32_t(2); i >= 0; i--) {
        ::java::lang::Object* rb = java_cast< ::org::apache::poi::hssf::record::RecordBase* >(npc(records)->get(i));
...
int32_t org::apache::poi::hssf::model::RecordOrderer::findDataValidationTableInsertPos(::java::util::List* records)
{
    clinit();
    auto i = npc(records)->size() - int32_t(1);
    if(!(dynamic_cast< ::org::apache::poi::hssf::record::EOFRecord* >(java_cast< ::org::apache::poi::hssf::record::RecordBase* >(npc(records)->get(i))) != nullptr)) {
        throw new ::java::lang::IllegalStateException(u"Last sheet record should be EOFRecord"_j);
    }
    while (i > 0) {
        i--;
        auto rb = java_cast< ::org::apache::poi::hssf::record::RecordBase* >(npc(records)->get(i));
        if(isDVTPriorRecord(rb)) {
            auto nextRec = java_cast< ::org::apache::poi::hssf::record::Record* >(java_cast< ::org::apache::poi::hssf::record::RecordBase* >(npc(records)->get(i + int32_t(1))));
...
bool org::apache::poi::hssf::model::RecordOrderer::isDVTPriorRecord(::org::apache::poi::hssf::record::RecordBase* rb)
{
    clinit();
    if(dynamic_cast< ::org::apache::poi::hssf::record::aggregates::MergedCellsTable* >(rb) != nullptr || dynamic_cast< ::org::apache::poi::hssf::record::aggregates::ConditionalFormattingTable* >(rb) != nullptr) {
        return true;
    }
    auto sid = npc((java_cast< ::org::apache::poi::hssf::record::Record* >(rb)))->getSid();
    switch (sid) {
    case ::org::apache::poi::hssf::record::WindowTwoRecord::sid:
    case ::org::apache::poi::hssf::record::UnknownRecord::SCL_00A0:
    case ::org::apache::poi::hssf::record::PaneRecord::sid:
    case ::org::apache::poi::hssf::record::SelectionRecord::sid:
    case ::org::apache::poi::hssf::record::UnknownRecord::STANDARDWIDTH_0099:
    case ::org::apache::poi::hssf::record::UnknownRecord::LABELRANGES_015F:
    ...
    case ::org::apache::poi::hssf::record::UnknownRecord::QUICKTIP_0800:
    case ::org::apache::poi::hssf::record::UnknownRecord::CODENAME_1BA:
        return true;
    }
...
bool org::apache::poi::hssf::model::RecordOrderer::isDVTSubsequentRecord(int16_t sid)
{
    clinit();
    switch (sid) {
    case ::org::apache::poi::hssf::record::UnknownRecord::SHEETEXT_0862:
    case ::org::apache::poi::hssf::record::UnknownRecord::SHEETPROTECTION_0867:
    case ::org::apache::poi::hssf::record::UnknownRecord::PLV_MAC:
...
int32_t org::apache::poi::hssf::model::RecordOrderer::getDimensionsIndex(::java::util::List* records)
{
    clinit();
    auto nRecs = npc(records)->size();
    for (auto i = int32_t(0); i < nRecs; i++) {
        if(dynamic_cast< ::org::apache::poi::hssf::record::DimensionsRecord* >(java_cast< ::org::apache::poi::hssf::record::RecordBase* >(npc(records)->get(i))) != nullptr) {
            return i;
        }
    }
...
int32_t org::apache::poi::hssf::model::RecordOrderer::getGutsRecordInsertPos(::java::util::List* records)
{
    clinit();
    auto dimensionsIndex = getDimensionsIndex(records);
    auto i = dimensionsIndex - int32_t(1);
...
bool org::apache::poi::hssf::model::RecordOrderer::isGutsPriorRecord(::org::apache::poi::hssf::record::RecordBase* rb)
{
    clinit();
    if(dynamic_cast< ::org::apache::poi::hssf::record::Record* >(rb) != nullptr) {
        auto record = java_cast< ::org::apache::poi::hssf::record::Record* >(rb);
...
bool org::apache::poi::hssf::model::RecordOrderer::isEndOfRowBlock(int32_t sid)
{
    clinit();
    switch (sid) {
    case ::org::apache::poi::hssf::record::pivottable::ViewDefinitionRecord::sid:
    case ::org::apache::poi::hssf::record::DrawingRecord::sid:
    ...
    return ::org::apache::poi::hssf::record::aggregates::PageSettingsBlock::isComponentRecord(sid);
}

bool org::apache::poi::hssf::model::RecordOrderer::isRowBlockRecord(int32_t sid)
{
    clinit();
    switch (sid) {
...
java::lang::Class* org::apache::poi::hssf::model::RecordOrderer::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.model.RecordOrderer", 39);
    return c;
}

java::lang::Class* org::apache::poi::hssf::model::RecordOrderer::getClass0()
{
    return class_();
}
