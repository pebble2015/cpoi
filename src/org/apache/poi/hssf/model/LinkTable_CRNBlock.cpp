...
org::apache::poi::hssf::model::LinkTable_CRNBlock::LinkTable_CRNBlock(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::apache::poi::hssf::model::LinkTable_CRNBlock::LinkTable_CRNBlock(RecordStream* rs) 
    : LinkTable_CRNBlock(*static_cast< ::default_init_tag* >(0))
{
    ctor(rs);
}

void org::apache::poi::hssf::model::LinkTable_CRNBlock::ctor(RecordStream* rs)
{
    super::ctor();
    _countRecord = java_cast< ::org::apache::poi::hssf::record::CRNCountRecord* >(npc(rs)->getNext());
    auto nCRNs = npc(_countRecord)->getNumberOfCRNs();
    auto crns = new ::org::apache::poi::hssf::record::CRNRecordArray(nCRNs);
    for (auto i = int32_t(0); i < npc(crns)->length; i++) {
        crns->set(i, java_cast< ::org::apache::poi::hssf::record::CRNRecord* >(npc(rs)->getNext()));
    }
    _crns = crns;
}

org::apache::poi::hssf::record::CRNRecordArray* org::apache::poi::hssf::model::LinkTable_CRNBlock::getCrns()
{
...
java::lang::Class* org::apache::poi::hssf::model::LinkTable_CRNBlock::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.model.LinkTable.CRNBlock", 44);
    return c;
}

java::lang::Class* org::apache::poi::hssf::model::LinkTable_CRNBlock::getClass0()
{
    return class_();
}
