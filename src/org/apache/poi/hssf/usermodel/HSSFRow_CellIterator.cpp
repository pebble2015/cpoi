...
org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::HSSFRow_CellIterator(HSSFRow *HSSFRow_this, const ::default_init_tag&)
...
org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::HSSFRow_CellIterator(HSSFRow *HSSFRow_this) 
    : HSSFRow_CellIterator(HSSFRow_this, *static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::init()
{
    thisId = -int32_t(1);
    nextId = -int32_t(1);
}

void org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::ctor()
{
    super::ctor();
    init();
    findNext();
...
bool org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::hasNext()
{
    return nextId < npc(HSSFRow_this->cells)->length;
}

org::apache::poi::ss::usermodel::Cell* org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::next()
{
    if(!hasNext())
...
void org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::remove()
{
    if(thisId == -int32_t(1))
...
void org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::findNext()
{
...
java::lang::Class* org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.usermodel.HSSFRow.CellIterator", 50);
    return c;
}

java::lang::Class* org::apache::poi::hssf::usermodel::HSSFRow_CellIterator::getClass0()
{
    return class_();
}
