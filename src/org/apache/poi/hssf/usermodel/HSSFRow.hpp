...
class org::apache::poi::hssf::usermodel::HSSFRow final
    : public virtual ::java::lang::Object
    , public ::org::apache::poi::ss::usermodel::Row
...
protected:
    ...
    void ctor(HSSFWorkbook* book, HSSFSheet* sheet, ::org::apache::poi::hssf::record::RowRecord* record);

public:
    ::org::apache::poi::ss::usermodel::Cell* createCell(int32_t column) override;
    ::org::apache::poi::ss::usermodel::Cell* createCell(int32_t columnIndex, int32_t type) override;
    ::org::apache::poi::ss::usermodel::Cell* createCell(int32_t columnIndex, ::org::apache::poi::ss::usermodel::CellType* type) override;
    void removeCell(::org::apache::poi::ss::usermodel::Cell* cell) override;
...
public: /* package */
    HSSFCell* createCellFromRecord(::org::apache::poi::hssf::record::CellValueRecordInterface* cell);
...
public:
    ::org::apache::poi::ss::usermodel::Cell* getCell(int32_t cellnum) override;
    ::org::apache::poi::ss::usermodel::Cell* getCell(int32_t cellnum, ::org::apache::poi::ss::usermodel::Row_MissingCellPolicy* policy) override;
...
public: /* protected */
    ::org::apache::poi::hssf::record::RowRecord* getRowRecord();
...
public:
    ...
    void setRowStyle(::org::apache::poi::ss::usermodel::CellStyle* style) override;
...
public: /* package */
    ...
    HSSFRow(HSSFWorkbook* book, HSSFSheet* sheet, ::org::apache::poi::hssf::record::RowRecord* record);
protected:
