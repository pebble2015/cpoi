...
org::apache::poi::hssf::usermodel::HSSFPatriarch::HSSFPatriarch(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::apache::poi::hssf::usermodel::HSSFPatriarch::HSSFPatriarch(HSSFSheet* sheet, ::org::apache::poi::hssf::record::EscherAggregate* boundAggregate) 
    : HSSFPatriarch(*static_cast< ::default_init_tag* >(0))
{
    ctor(sheet,boundAggregate);
}

void org::apache::poi::hssf::usermodel::HSSFPatriarch::init()
{
    _shapes = new ::java::util::ArrayList();
}

void org::apache::poi::hssf::usermodel::HSSFPatriarch::ctor(HSSFSheet* sheet, ::org::apache::poi::hssf::record::EscherAggregate* boundAggregate)
{
    super::ctor();
    init();
    _sheet = sheet;
    _boundAggregate = boundAggregate;
    _mainSpgrContainer = java_cast< ::org::apache::poi::ddf::EscherContainerRecord* >(npc(npc(npc(_boundAggregate)->getEscherContainer())->getChildContainers())->get(0));
    auto spContainer = java_cast< ::org::apache::poi::ddf::EscherContainerRecord* >(npc(java_cast< ::org::apache::poi::ddf::EscherContainerRecord* >(npc(npc(npc(_boundAggregate)->getEscherContainer())->getChildContainers())->get(0)))->getChild(int32_t(0)));
    _spgrRecord = java_cast< ::org::apache::poi::ddf::EscherSpgrRecord* >(npc(spContainer)->getChildById(::org::apache::poi::ddf::EscherSpgrRecord::RECORD_ID));
    buildShapeTree();
}

org::apache::poi::hssf::usermodel::HSSFPatriarch* org::apache::poi::hssf::usermodel::HSSFPatriarch::createPatriarch(HSSFPatriarch* patriarch, HSSFSheet* sheet)
{
    clinit();
    auto newPatriarch = new HSSFPatriarch(sheet, new ::org::apache::poi::hssf::record::EscherAggregate(true));
...
void org::apache::poi::hssf::usermodel::HSSFPatriarch::preSerialize()
{
    ...
    for (auto _i = npc(npc(tailRecords)->values())->iterator(); _i->hasNext(); ) {
        ::org::apache::poi::hssf::record::NoteRecord* rec = java_cast< ::org::apache::poi::hssf::record::NoteRecord* >(_i->next());
        {
            auto noteRef = (new ::org::apache::poi::hssf::util::CellReference(npc(rec)->getRow(), npc(rec)->getColumn()))->formatAsString();
...
bool org::apache::poi::hssf::usermodel::HSSFPatriarch::removeShape(HSSFShape* shape)
{
...
void org::apache::poi::hssf::usermodel::HSSFPatriarch::afterCreate()
{
...
org::apache::poi::hssf::usermodel::HSSFShapeGroup* org::apache::poi::hssf::usermodel::HSSFPatriarch::createGroup(HSSFClientAnchor* anchor)
{
...
org::apache::poi::hssf::usermodel::HSSFSimpleShape* org::apache::poi::hssf::usermodel::HSSFPatriarch::createSimpleShape(HSSFClientAnchor* anchor)
{
...
org::apache::poi::hssf::usermodel::HSSFPicture* org::apache::poi::hssf::usermodel::HSSFPatriarch::createPicture(HSSFClientAnchor* anchor, int32_t pictureIndex)
{
...
org::apache::poi::ss::usermodel::Picture* org::apache::poi::hssf::usermodel::HSSFPatriarch::createPicture(::org::apache::poi::ss::usermodel::ClientAnchor* anchor, int32_t pictureIndex)
{
    return createPicture(java_cast< HSSFClientAnchor* >(anchor), pictureIndex);
}

org::apache::poi::ss::usermodel::ObjectData* org::apache::poi::hssf::usermodel::HSSFPatriarch::createObjectData(::org::apache::poi::ss::usermodel::ClientAnchor* anchor, int32_t storageId, int32_t pictureIndex)
{
    auto obj = new ::org::apache::poi::hssf::record::ObjRecord();
    auto ftCmo = new ::org::apache::poi::hssf::record::CommonObjectDataSubRecord();
    npc(ftCmo)->setObjectType(::org::apache::poi::hssf::record::CommonObjectDataSubRecord::OBJECT_TYPE_PICTURE);
    ...
    auto ftCf = new ::org::apache::poi::hssf::record::FtCfSubRecord();
    ...
    case ::org::apache::poi::ss::usermodel::Workbook::PICTURE_TYPE_EMF:
        npc(ftCf)->setFlags(::org::apache::poi::hssf::record::FtCfSubRecord::METAFILE_BIT);
        break;
    ...
    case ::org::apache::poi::ss::usermodel::Workbook::PICTURE_TYPE_PICT:
        npc(ftCf)->setFlags(::org::apache::poi::hssf::record::FtCfSubRecord::BITMAP_BIT);
        break;
    default:
    ...
    auto ftPioGrbit = new ::org::apache::poi::hssf::record::FtPioGrbitSubRecord();
    npc(ftPioGrbit)->setFlagByBit(::org::apache::poi::hssf::record::FtPioGrbitSubRecord::AUTO_PICT_BIT, true);
    npc(obj)->addSubRecord(ftPioGrbit);
    auto ftPictFmla = new ::org::apache::poi::hssf::record::EmbeddedObjectRefSubRecord();
    ...
    npc(obj)->addSubRecord(new ::org::apache::poi::hssf::record::EndSubRecord());
    auto entryName = ::java::lang::StringBuilder().append(u"MBD"_j)->append(::org::apache::poi::util::HexDump::toHex(storageId))->toString();
    ::org::apache::poi::poifs::filesystem::DirectoryEntry* oleRoot;
    try {
        auto dn = npc(java_cast< HSSFWorkbook* >(npc(_sheet)->getWorkbook()))->getDirectory();
        if(dn == nullptr) {
            throw new ::java::io::FileNotFoundException();
        }
        oleRoot = java_cast< ::org::apache::poi::poifs::filesystem::DirectoryEntry* >(npc(dn)->getEntry(entryName));
    ...
    auto spRecord = java_cast< ::org::apache::poi::ddf::EscherSpRecord* >(npc(spContainer)->getChildById(::org::apache::poi::ddf::EscherSpRecord::RECORD_ID));
    npc(spRecord)->setFlags(npc(spRecord)->getFlags() | ::org::apache::poi::ddf::EscherSpRecord::FLAG_OLESHAPE);
...
org::apache::poi::hssf::usermodel::HSSFPolygon* org::apache::poi::hssf::usermodel::HSSFPatriarch::createPolygon(HSSFClientAnchor* anchor)
{
...
org::apache::poi::hssf::usermodel::HSSFTextbox* org::apache::poi::hssf::usermodel::HSSFPatriarch::createTextbox(HSSFClientAnchor* anchor)
{
...
org::apache::poi::hssf::usermodel::HSSFComment* org::apache::poi::hssf::usermodel::HSSFPatriarch::createComment(HSSFAnchor* anchor)
{
...
org::apache::poi::hssf::usermodel::HSSFSimpleShape* org::apache::poi::hssf::usermodel::HSSFPatriarch::createComboBox(HSSFAnchor* anchor)
{
...
org::apache::poi::hssf::usermodel::HSSFComment* org::apache::poi::hssf::usermodel::HSSFPatriarch::createCellComment(::org::apache::poi::ss::usermodel::ClientAnchor* anchor)
{
    return createComment(java_cast< HSSFAnchor* >(anchor));
}

java::util::List* org::apache::poi::hssf::usermodel::HSSFPatriarch::getChildren()
{
    return ::java::util::Collections::unmodifiableList(_shapes);
}

void org::apache::poi::hssf::usermodel::HSSFPatriarch::addShape(HSSFShape* shape)
{
    npc(shape)->setPatriarch(this);
    npc(_shapes)->add(static_cast< ::java::lang::Object* >(shape));
}

void org::apache::poi::hssf::usermodel::HSSFPatriarch::onCreate(HSSFShape* shape)
{
    auto spgrContainer = java_cast< ::org::apache::poi::ddf::EscherContainerRecord* >(npc(npc(npc(_boundAggregate)->getEscherContainer())->getChildContainers())->get(0));
    auto spContainer = npc(shape)->getEscherContainer();
...
int32_t org::apache::poi::hssf::usermodel::HSSFPatriarch::countOfAllChildren()
{
...
void org::apache::poi::hssf::usermodel::HSSFPatriarch::setCoordinates(int32_t x1, int32_t y1, int32_t x2, int32_t y2)
{
...
void org::apache::poi::hssf::usermodel::HSSFPatriarch::clear()
{
...
int32_t org::apache::poi::hssf::usermodel::HSSFPatriarch::newShapeId()
{
    auto dm = npc(npc(java_cast< HSSFWorkbook* >(npc(_sheet)->getWorkbook()))->getWorkbook())->getDrawingManager();
    auto dg = java_cast< ::org::apache::poi::ddf::EscherDgRecord* >(npc(npc(_boundAggregate)->getEscherContainer())->getChildById(::org::apache::poi::ddf::EscherDgRecord::RECORD_ID));
    return npc(dm)->allocateShapeId(dg);
}

bool org::apache::poi::hssf::usermodel::HSSFPatriarch::containsChart()
{
    auto optRecord = java_cast< ::org::apache::poi::ddf::EscherOptRecord* >(npc(_boundAggregate)->findFirstWithId(::org::apache::poi::ddf::EscherOptRecord::RECORD_ID));
    if(optRecord == nullptr) {
        return false;
    }
    for (auto *it = npc(npc(optRecord)->getEscherProperties())->iterator(); npc(it)->hasNext(); ) {
        auto prop = java_cast< ::org::apache::poi::ddf::EscherProperty* >(npc(it)->next());
        if(npc(prop)->getPropertyNumber() == 896 && npc(prop)->isComplex()) {
            auto cp = java_cast< ::org::apache::poi::ddf::EscherComplexProperty* >(prop);
            auto str = ::org::apache::poi::util::StringUtil::getFromUnicodeLE(npc(cp)->getComplexData());
...
int32_t org::apache::poi::hssf::usermodel::HSSFPatriarch::getX1()
{
    return npc(_spgrRecord)->getRectX1();
}

int32_t org::apache::poi::hssf::usermodel::HSSFPatriarch::getY1()
{
    return npc(_spgrRecord)->getRectY1();
}

int32_t org::apache::poi::hssf::usermodel::HSSFPatriarch::getX2()
{
    return npc(_spgrRecord)->getRectX2();
}

int32_t org::apache::poi::hssf::usermodel::HSSFPatriarch::getY2()
{
    return npc(_spgrRecord)->getRectY2();
}

org::apache::poi::hssf::record::EscherAggregate* org::apache::poi::hssf::usermodel::HSSFPatriarch::getBoundAggregate()
{
    return _boundAggregate;
}

org::apache::poi::hssf::usermodel::HSSFClientAnchor* org::apache::poi::hssf::usermodel::HSSFPatriarch::createAnchor(int32_t dx1, int32_t dy1, int32_t dx2, int32_t dy2, int32_t col1, int32_t row1, int32_t col2, int32_t row2)
{
    return new HSSFClientAnchor(dx1, dy1, dx2, dy2, static_cast< int16_t >(col1), row1, static_cast< int16_t >(col2), row2);
}

org::apache::poi::ss::usermodel::Chart* org::apache::poi::hssf::usermodel::HSSFPatriarch::createChart(::org::apache::poi::ss::usermodel::ClientAnchor* anchor)
{
    throw new ::java::lang::RuntimeException(u"NotImplemented"_j);
}

void org::apache::poi::hssf::usermodel::HSSFPatriarch::buildShapeTree()
{
    auto dgContainer = npc(_boundAggregate)->getEscherContainer();
    if(dgContainer == nullptr) {
        return;
    }
    auto spgrConrainer = java_cast< ::org::apache::poi::ddf::EscherContainerRecord* >(npc(npc(dgContainer)->getChildContainers())->get(0));
    auto spgrChildren = npc(spgrConrainer)->getChildContainers();
    for (auto i = int32_t(0); i < npc(spgrChildren)->size(); i++) {
        auto spContainer = java_cast< ::org::apache::poi::ddf::EscherContainerRecord* >(npc(spgrChildren)->get(i));
        if(i != 0) {
...
void org::apache::poi::hssf::usermodel::HSSFPatriarch::setFlipFlags(HSSFShape* shape)
{
...
java::util::Iterator* org::apache::poi::hssf::usermodel::HSSFPatriarch::iterator()
{
    return npc(_shapes)->iterator();
}

org::apache::poi::hssf::usermodel::HSSFSheet* org::apache::poi::hssf::usermodel::HSSFPatriarch::getSheet()
{
    return _sheet;
}
...
java::lang::Class* org::apache::poi::hssf::usermodel::HSSFPatriarch::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.hssf.usermodel.HSSFPatriarch", 43);
    return c;
}

java::lang::Class* org::apache::poi::hssf::usermodel::HSSFPatriarch::getClass0()
{
    return class_();
}
