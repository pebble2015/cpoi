...
org::apache::poi::poifs::storage::SmallDocumentBlockList::SmallDocumentBlockList(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::apache::poi::poifs::storage::SmallDocumentBlockList::SmallDocumentBlockList(::java::util::List* blocks) 
    : SmallDocumentBlockList(*static_cast< ::default_init_tag* >(0))
{
    ctor(blocks);
}

void org::apache::poi::poifs::storage::SmallDocumentBlockList::ctor(::java::util::List* blocks)
{
    super::ctor();
...
java::lang::Class* org::apache::poi::poifs::storage::SmallDocumentBlockList::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.poifs.storage.SmallDocumentBlockList", 51);
    return c;
}

java::lang::Class* org::apache::poi::poifs::storage::SmallDocumentBlockList::getClass0()
{
    return class_();
}
