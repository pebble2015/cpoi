...
org::apache::poi::poifs::storage::HeaderBlockWriter::HeaderBlockWriter(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::apache::poi::poifs::storage::HeaderBlockWriter::HeaderBlockWriter(::org::apache::poi::poifs::common::POIFSBigBlockSize* bigBlockSize) 
    : HeaderBlockWriter(*static_cast< ::default_init_tag* >(0))
{
    ctor(bigBlockSize);
}

org::apache::poi::poifs::storage::HeaderBlockWriter::HeaderBlockWriter(HeaderBlock* headerBlock) 
    : HeaderBlockWriter(*static_cast< ::default_init_tag* >(0))
{
    ctor(headerBlock);
}

void org::apache::poi::poifs::storage::HeaderBlockWriter::ctor(::org::apache::poi::poifs::common::POIFSBigBlockSize* bigBlockSize)
{
    super::ctor();
    _header_block = new HeaderBlock(bigBlockSize);
}

void org::apache::poi::poifs::storage::HeaderBlockWriter::ctor(HeaderBlock* headerBlock)
{
    super::ctor();
    _header_block = headerBlock;
}

org::apache::poi::poifs::storage::BATBlockArray* org::apache::poi::poifs::storage::HeaderBlockWriter::setBATBlocks(int32_t blockCount, int32_t startBlock)
{
    ...
    if(blockCount > _max_bats_in_header) {
        ...
        npc(_header_block)->setXBATStart(::org::apache::poi::poifs::common::POIFSConstants::END_OF_CHAIN);
    }
    npc(_header_block)->setXBATCount(npc(rvalue)->length);
    return rvalue;
}

void org::apache::poi::poifs::storage::HeaderBlockWriter::setPropertyStart(int32_t startBlock)
{
    npc(_header_block)->setPropertyStart(startBlock);
}

void org::apache::poi::poifs::storage::HeaderBlockWriter::setSBATStart(int32_t startBlock)
{
    npc(_header_block)->setSBATStart(startBlock);
}

void org::apache::poi::poifs::storage::HeaderBlockWriter::setSBATBlockCount(int32_t count)
{
    npc(_header_block)->setSBATBlockCount(count);
}

int32_t org::apache::poi::poifs::storage::HeaderBlockWriter::calculateXBATStorageRequirements(::org::apache::poi::poifs::common::POIFSBigBlockSize* bigBlockSize, int32_t blockCount)
{
    clinit();
...
void org::apache::poi::poifs::storage::HeaderBlockWriter::writeBlocks(::java::io::OutputStream* stream) /* throws(IOException) */
{
    npc(_header_block)->writeData(stream);
}

void org::apache::poi::poifs::storage::HeaderBlockWriter::writeBlock(::java::nio::ByteBuffer* block) /* throws(IOException) */
{
...
java::lang::Class* org::apache::poi::poifs::storage::HeaderBlockWriter::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.poifs.storage.HeaderBlockWriter", 46);
    return c;
}

java::lang::Class* org::apache::poi::poifs::storage::HeaderBlockWriter::getClass0()
{
    return class_();
}
