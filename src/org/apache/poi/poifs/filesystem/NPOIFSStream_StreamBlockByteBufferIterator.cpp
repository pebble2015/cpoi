...
poi::poifs::filesystem::NPOIFSStream_StreamBlockByteBufferIterator::NPOIFSStream_StreamBlockByteBufferIterator(NPOIFSStream *NPOIFSStream_this, const ::default_init_tag&)
...
poi::poifs::filesystem::NPOIFSStream_StreamBlockByteBufferIterator::NPOIFSStream_StreamBlockByteBufferIterator(NPOIFSStream *NPOIFSStream_this, int32_t firstBlock) 
    : NPOIFSStream_StreamBlockByteBufferIterator(NPOIFSStream_this, *static_cast< ::default_init_tag* >(0))
{
    ctor(firstBlock);
}

void poi::poifs::filesystem::NPOIFSStream_StreamBlockByteBufferIterator::ctor(int32_t firstBlock)
{
    super::ctor();
...
bool poi::poifs::filesystem::NPOIFSStream_StreamBlockByteBufferIterator::hasNext()
{
    if(nextBlock == ::poi::poifs::common::POIFSConstants::END_OF_CHAIN) {
        return false;
    }
    return true;
}

java::nio::ByteBuffer* poi::poifs::filesystem::NPOIFSStream_StreamBlockByteBufferIterator::next()
{
    if(nextBlock == ::poi::poifs::common::POIFSConstants::END_OF_CHAIN) {
...
void poi::poifs::filesystem::NPOIFSStream_StreamBlockByteBufferIterator::remove()
{
...
java::lang::Class* poi::poifs::filesystem::NPOIFSStream_StreamBlockByteBufferIterator::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.poifs.filesystem.NPOIFSStream.StreamBlockByteBufferIterator", 74);
    return c;
}

java::lang::Class* poi::poifs::filesystem::NPOIFSStream_StreamBlockByteBufferIterator::getClass0()
{
    return class_();
}
