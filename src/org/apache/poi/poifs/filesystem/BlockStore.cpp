...
poi::poifs::filesystem::BlockStore::BlockStore(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::poifs::filesystem::BlockStore::BlockStore()
...
java::lang::Class* poi::poifs::filesystem::BlockStore::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.poifs.filesystem.BlockStore", 42);
    return c;
}

java::lang::Class* poi::poifs::filesystem::BlockStore::getClass0()
{
    return class_();
}
