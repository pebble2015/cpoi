...
poi::poifs::crypt::cryptoapi::CryptoAPIEncryptor_createEncryptionInfoEntry_1::CryptoAPIEncryptor_createEncryptionInfoEntry_1(CryptoAPIEncryptor *CryptoAPIEncryptor_this, ::poi::poifs::crypt::EncryptionInfo* info, CryptoAPIEncryptionHeader* header, CryptoAPIEncryptionVerifier* verifier)
...
void poi::poifs::crypt::cryptoapi::CryptoAPIEncryptor_createEncryptionInfoEntry_1::write(::poi::util::LittleEndianByteArrayOutputStream* bos)
{
...
java::lang::Class* poi::poifs::crypt::cryptoapi::CryptoAPIEncryptor_createEncryptionInfoEntry_1::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* poi::poifs::crypt::cryptoapi::CryptoAPIEncryptor_createEncryptionInfoEntry_1::getClass0()
{
    return class_();
}
