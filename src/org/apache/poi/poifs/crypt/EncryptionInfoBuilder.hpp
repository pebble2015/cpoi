...
struct org::apache::poi::poifs::crypt::EncryptionInfoBuilder
    : public virtual ::java::lang::Object
{
    virtual void initialize(EncryptionInfo* ei, ::org::apache::poi::util::LittleEndianInput* dis) /* throws(IOException) */ = 0;
