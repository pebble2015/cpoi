...
class poi::poifs::crypt::binaryrc4::BinaryRC4Encryptor_BinaryRC4CipherOutputStream
...
public:
    ...
    BinaryRC4Encryptor_BinaryRC4CipherOutputStream(BinaryRC4Encryptor *BinaryRC4Encryptor_this, ::poi::poifs::filesystem::DirectoryNode* dir);
protected:
