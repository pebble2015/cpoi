...
org::apache::poi::poifs::crypt::standard::StandardEncryptor::StandardEncryptor(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::apache::poi::poifs::crypt::standard::StandardEncryptor::StandardEncryptor() 
    : StandardEncryptor(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

org::apache::poi::util::POILogger*& org::apache::poi::poifs::crypt::standard::StandardEncryptor::logger()
{
    clinit();
    return logger_;
}
org::apache::poi::util::POILogger* org::apache::poi::poifs::crypt::standard::StandardEncryptor::logger_;

void org::apache::poi::poifs::crypt::standard::StandardEncryptor::ctor()
{
    super::ctor();
}

void org::apache::poi::poifs::crypt::standard::StandardEncryptor::confirmPassword(::java::lang::String* password)
{
...
void org::apache::poi::poifs::crypt::standard::StandardEncryptor::confirmPassword(::java::lang::String* password, ::int8_tArray* keySpec, ::int8_tArray* keySalt, ::int8_tArray* verifier, ::int8_tArray* verifierSalt, ::int8_tArray* integritySalt)
{
    ...
    try {
        ...
        auto hashAlgo = ::org::apache::poi::poifs::crypt::CryptoFunctions::getMessageDigest(npc(ver)->getHashAlgorithm());
...
javax::crypto::Cipher* org::apache::poi::poifs::crypt::standard::StandardEncryptor::getCipher(::javax::crypto::SecretKey* key, ::java::lang::String* padding)
{
    auto ver = npc(getEncryptionInfo())->getVerifier();
    return ::org::apache::poi::poifs::crypt::CryptoFunctions::getCipher(key, npc(ver)->getCipherAlgorithm(), npc(ver)->getChainingMode(), nullptr, ::javax::crypto::Cipher::ENCRYPT_MODE, padding);
}

java::io::OutputStream* org::apache::poi::poifs::crypt::standard::StandardEncryptor::getDataStream(::org::apache::poi::poifs::filesystem::DirectoryNode* dir) /* throws(IOException, GeneralSecurityException) */
{
...
int32_t org::apache::poi::poifs::crypt::standard::StandardEncryptor::getKeySizeInBytes()
{
    return npc(npc(getEncryptionInfo())->getHeader())->getKeySize() / int32_t(8);
}

void org::apache::poi::poifs::crypt::standard::StandardEncryptor::createEncryptionInfoEntry(::org::apache::poi::poifs::filesystem::DirectoryNode* dir) /* throws(IOException) */
{
...
org::apache::poi::poifs::crypt::standard::StandardEncryptor* org::apache::poi::poifs::crypt::standard::StandardEncryptor::clone() /* throws(CloneNotSupportedException) */
{
...
java::lang::Class* org::apache::poi::poifs::crypt::standard::StandardEncryptor::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.poifs.crypt.standard.StandardEncryptor", 53);
    return c;
}

void org::apache::poi::poifs::crypt::standard::StandardEncryptor::clinit()
{
    super::clinit();
...
struct clinit_ {
    clinit_() {
        in_cl_init = true;
        logger_ = ::org::apache::poi::util::POILogFactory::getLogger(static_cast< ::java::lang::Class* >(StandardEncryptor::class_()));
    }
};
...
java::io::OutputStream* org::apache::poi::poifs::crypt::standard::StandardEncryptor::getDataStream(::org::apache::poi::poifs::filesystem::NPOIFSFileSystem* fs)
{
    return super::getDataStream(fs);
}

java::io::OutputStream* org::apache::poi::poifs::crypt::standard::StandardEncryptor::getDataStream(::org::apache::poi::poifs::filesystem::OPOIFSFileSystem* fs)
{
    return super::getDataStream(fs);
}

java::io::OutputStream* org::apache::poi::poifs::crypt::standard::StandardEncryptor::getDataStream(::org::apache::poi::poifs::filesystem::POIFSFileSystem* fs)
{
    return super::getDataStream(fs);
}

org::apache::poi::poifs::crypt::ChunkedCipherOutputStream* org::apache::poi::poifs::crypt::standard::StandardEncryptor::getDataStream(::java::io::OutputStream* stream, int32_t initialOffset)
{
    return super::getDataStream(stream, initialOffset);
}

java::lang::Class* org::apache::poi::poifs::crypt::standard::StandardEncryptor::getClass0()
{
    return class_();
}
