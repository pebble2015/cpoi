...
class org::apache::poi::poifs::crypt::standard::StandardEncryptor
...
public:
    ...
    virtual ::org::apache::poi::poifs::crypt::ChunkedCipherOutputStream* getDataStream(::java::io::OutputStream* stream, int32_t initialOffset);
