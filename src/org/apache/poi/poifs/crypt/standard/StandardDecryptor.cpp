...
poi::poifs::crypt::standard::StandardDecryptor::StandardDecryptor(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::poifs::crypt::standard::StandardDecryptor::StandardDecryptor() 
    : StandardDecryptor(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void poi::poifs::crypt::standard::StandardDecryptor::init()
{
    _length = -int32_t(1);
}

void poi::poifs::crypt::standard::StandardDecryptor::ctor()
{
    super::ctor();
    init();
}

bool poi::poifs::crypt::standard::StandardDecryptor::verifyPassword(::java::lang::String* password)
{
    ...
    try {
        ...
        auto sha1 = ::poi::poifs::crypt::CryptoFunctions::getMessageDigest(npc(ver)->getHashAlgorithm());
...
javax::crypto::SecretKey* poi::poifs::crypt::standard::StandardDecryptor::generateSecretKey(::java::lang::String* password, ::poi::poifs::crypt::EncryptionVerifier* ver, int32_t keySize)
{
    clinit();
    auto hashAlgo = npc(ver)->getHashAlgorithm();
    auto pwHash = ::poi::poifs::crypt::CryptoFunctions::hashPassword(password, hashAlgo, npc(ver)->getSalt(), npc(ver)->getSpinCount());
    auto blockKey = new ::int8_tArray(int32_t(4));
    ::poi::util::LittleEndian::putInt(blockKey, 0, 0);
    auto finalHash = ::poi::poifs::crypt::CryptoFunctions::generateKey(pwHash, hashAlgo, blockKey, npc(hashAlgo)->hashSize);
...
int8_tArray* poi::poifs::crypt::standard::StandardDecryptor::fillAndXor(::int8_tArray* hash, int8_t fillByte)
{
    clinit();
    ...
    auto sha1 = ::poi::poifs::crypt::CryptoFunctions::getMessageDigest(::poi::poifs::crypt::HashAlgorithm::sha1);
    return npc(sha1)->digest(buff);
}

javax::crypto::Cipher* poi::poifs::crypt::standard::StandardDecryptor::getCipher(::javax::crypto::SecretKey* key)
{
    auto em = npc(getEncryptionInfo())->getHeader();
    auto cm = npc(em)->getChainingMode();
    /* assert((cm == ::poi::poifs::crypt::ChainingMode::ecb)) */ ;
    return ::poi::poifs::crypt::CryptoFunctions::getCipher(key, npc(em)->getCipherAlgorithm(), cm, nullptr, ::javax::crypto::Cipher::DECRYPT_MODE);
}

java::io::InputStream* poi::poifs::crypt::standard::StandardDecryptor::getDataStream(::poi::poifs::filesystem::DirectoryNode* dir) /* throws(IOException) */
{
    ...
    ::java::io::InputStream* boundedDis = new ::poi::util::BoundedInputStream(dis, cipherLen);
    return new ::poi::util::BoundedInputStream(new ::javax::crypto::CipherInputStream(boundedDis, cipher), _length);
}

int64_t poi::poifs::crypt::standard::StandardDecryptor::getLength()
{
...
poi::poifs::crypt::standard::StandardDecryptor* poi::poifs::crypt::standard::StandardDecryptor::clone() /* throws(CloneNotSupportedException) */
{
...
java::lang::Class* poi::poifs::crypt::standard::StandardDecryptor::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.poifs.crypt.standard.StandardDecryptor", 53);
    return c;
}

java::io::InputStream* poi::poifs::crypt::standard::StandardDecryptor::getDataStream(::java::io::InputStream* stream, int32_t size, int32_t initialPos)
{
    return super::getDataStream(stream, size, initialPos);
}

java::io::InputStream* poi::poifs::crypt::standard::StandardDecryptor::getDataStream(::poi::poifs::filesystem::NPOIFSFileSystem* fs)
{
    return super::getDataStream(fs);
}

java::io::InputStream* poi::poifs::crypt::standard::StandardDecryptor::getDataStream(::poi::poifs::filesystem::OPOIFSFileSystem* fs)
{
    return super::getDataStream(fs);
}

java::io::InputStream* poi::poifs::crypt::standard::StandardDecryptor::getDataStream(::poi::poifs::filesystem::POIFSFileSystem* fs)
{
    return super::getDataStream(fs);
}

java::lang::Class* poi::poifs::crypt::standard::StandardDecryptor::getClass0()
{
    return class_();
}
