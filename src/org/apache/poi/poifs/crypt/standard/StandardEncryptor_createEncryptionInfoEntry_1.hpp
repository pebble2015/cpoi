...
class poi::poifs::crypt::standard::StandardEncryptor_createEncryptionInfoEntry_1
...
public:
    ...
    // Generated
    StandardEncryptor_createEncryptionInfoEntry_1(StandardEncryptor *StandardEncryptor_this, ::poi::poifs::crypt::EncryptionInfo* info, StandardEncryptionHeader* header, StandardEncryptionVerifier* verifier);
