...
poi::ddf::EscherMetafileBlip::EscherMetafileBlip(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ddf::EscherMetafileBlip::EscherMetafileBlip()
    : EscherMetafileBlip(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void poi::ddf::EscherMetafileBlip::ctor()
{
    super::ctor();
    init();
}

void poi::ddf::EscherMetafileBlip::init()
{
    field_1_UID = new ::int8_tArray(int32_t(16));
    field_2_UID = new ::int8_tArray(int32_t(16));
}

poi::util::POILogger*& poi::ddf::EscherMetafileBlip::log()
{
    clinit();
    return log_;
}
poi::util::POILogger* poi::ddf::EscherMetafileBlip::log_;

constexpr int16_t poi::ddf::EscherMetafileBlip::RECORD_ID_EMF;

constexpr int16_t poi::ddf::EscherMetafileBlip::RECORD_ID_WMF;

constexpr int16_t poi::ddf::EscherMetafileBlip::RECORD_ID_PICT;

constexpr int32_t poi::ddf::EscherMetafileBlip::HEADER_SIZE;

int32_t poi::ddf::EscherMetafileBlip::fillFields(::int8_tArray* data, int32_t offset, EscherRecordFactory* recordFactory)
{
...
int32_t poi::ddf::EscherMetafileBlip::serialize(int32_t offset, ::int8_tArray* data, EscherSerializationListener* listener)
{
    ...
    pos += 2;
    ::poi::util::LittleEndian::putInt(data, pos, getRecordSize() - HEADER_SIZE);
    pos += 4;
...
int8_tArray* poi::ddf::EscherMetafileBlip::inflatePictureData(::int8_tArray* data)
{
    clinit();
    try {
        ...
        npc(log_)->log(::poi::util::POILogger::WARN, new ::java::lang::ObjectArray({static_cast< ::java::lang::Object* >(u"Possibly corrupt compression or non-compressed data"_j), static_cast< ::java::lang::Object* >(e)}));
        return data;
    }
}

int32_t poi::ddf::EscherMetafileBlip::getRecordSize()
{
...
int8_tArray* poi::ddf::EscherMetafileBlip::getUID()
{
    return field_1_UID;
}

void poi::ddf::EscherMetafileBlip::setUID(::int8_tArray* uid)
{
...
int8_tArray* poi::ddf::EscherMetafileBlip::getPrimaryUID()
{
    return field_2_UID;
}

void poi::ddf::EscherMetafileBlip::setPrimaryUID(::int8_tArray* primaryUID)
{
...
int32_t poi::ddf::EscherMetafileBlip::getUncompressedSize()
{
    return field_2_cb;
}

void poi::ddf::EscherMetafileBlip::setUncompressedSize(int32_t uncompressedSize)
{
    field_2_cb = uncompressedSize;
}

java::awt::Rectangle* poi::ddf::EscherMetafileBlip::getBounds()
{
...
void poi::ddf::EscherMetafileBlip::setBounds(::java::awt::Rectangle* bounds)
{
...
java::awt::Dimension* poi::ddf::EscherMetafileBlip::getSizeEMU()
{
    return new ::java::awt::Dimension(field_4_ptSize_w, field_4_ptSize_h);
}

void poi::ddf::EscherMetafileBlip::setSizeEMU(::java::awt::Dimension* sizeEMU)
{
    field_4_ptSize_w = npc(sizeEMU)->width;
    field_4_ptSize_h = npc(sizeEMU)->height;
}

int32_t poi::ddf::EscherMetafileBlip::getCompressedSize()
{
    return field_5_cbSave;
}

void poi::ddf::EscherMetafileBlip::setCompressedSize(int32_t compressedSize)
{
    field_5_cbSave = compressedSize;
}

bool poi::ddf::EscherMetafileBlip::isCompressed()
{
    return (field_6_fCompression == 0);
}

void poi::ddf::EscherMetafileBlip::setCompressed(bool compressed)
{
    field_6_fCompression = compressed ? static_cast< int8_t >(int32_t(0)) : static_cast< int8_t >(int32_t(254));
}

int8_t poi::ddf::EscherMetafileBlip::getFilter()
{
    return field_7_fFilter;
}

void poi::ddf::EscherMetafileBlip::setFilter(int8_t filter)
{
    field_7_fFilter = filter;
}

int8_tArray* poi::ddf::EscherMetafileBlip::getRemainingData()
{
    return remainingData;
}

int16_t poi::ddf::EscherMetafileBlip::getSignature()
{
    switch (getRecordId()) {
    case RECORD_ID_EMF:
        return ::poi::hssf::usermodel::HSSFPictureData::MSOBI_EMF;
    case RECORD_ID_WMF:
        return ::poi::hssf::usermodel::HSSFPictureData::MSOBI_WMF;
    case RECORD_ID_PICT:
        return ::poi::hssf::usermodel::HSSFPictureData::MSOBI_PICT;
    }

    if(npc(log_)->check(::poi::util::POILogger::WARN)) {
        npc(log_)->log(::poi::util::POILogger::WARN, new ::java::lang::ObjectArray({static_cast< ::java::lang::Object* >(::java::lang::StringBuilder().append(u"Unknown metafile: "_j)->append(getRecordId())->toString())}));
    }
    return 0;
}

void poi::ddf::EscherMetafileBlip::setPictureData(::int8_tArray* pictureData)
{
...
java::lang::ObjectArrayArray* poi::ddf::EscherMetafileBlip::getAttributeMap()
{
...
java::lang::Class* poi::ddf::EscherMetafileBlip::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ddf.EscherMetafileBlip", 37);
    return c;
}

void poi::ddf::EscherMetafileBlip::clinit()
{
    super::clinit();
...
struct clinit_ {
    clinit_() {
        in_cl_init = true;
        log_ = ::poi::util::POILogFactory::getLogger(static_cast< ::java::lang::Class* >(EscherMetafileBlip::class_()));
    }
};
...
void poi::ddf::EscherMetafileBlip::setPictureData(::int8_tArray* pictureData, int32_t offset, int32_t length)
{
    super::setPictureData(pictureData, offset, length);
}

int32_t poi::ddf::EscherMetafileBlip::fillFields(::int8_tArray* data, EscherRecordFactory* f)
{
    return super::fillFields(data, f);
}

int8_tArray* poi::ddf::EscherMetafileBlip::serialize()
{
    return super::serialize();
}

int32_t poi::ddf::EscherMetafileBlip::serialize(int32_t offset, ::int8_tArray* data)
{
    return super::serialize(offset, data);
}

java::lang::Class* poi::ddf::EscherMetafileBlip::getClass0()
{
    return class_();
}
