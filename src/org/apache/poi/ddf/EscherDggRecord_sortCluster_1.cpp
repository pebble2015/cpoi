...
poi::ddf::EscherDggRecord_sortCluster_1::EscherDggRecord_sortCluster_1(EscherDggRecord *EscherDggRecord_this)
...
int32_t poi::ddf::EscherDggRecord_sortCluster_1::compare(EscherDggRecord_FileIdCluster* f1, EscherDggRecord_FileIdCluster* f2)
{
...
int32_t poi::ddf::EscherDggRecord_sortCluster_1::compare(::java::lang::Object* o1, ::java::lang::Object* o2)
{ 
...
java::lang::Class* poi::ddf::EscherDggRecord_sortCluster_1::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

bool poi::ddf::EscherDggRecord_sortCluster_1::equals(::java::lang::Object* obj)
{
    return Object::equals(obj);
}

java::lang::Class* poi::ddf::EscherDggRecord_sortCluster_1::getClass0()
{
    return class_();
}
