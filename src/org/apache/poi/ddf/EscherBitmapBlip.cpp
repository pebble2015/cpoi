...
poi::ddf::EscherBitmapBlip::EscherBitmapBlip(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ddf::EscherBitmapBlip::EscherBitmapBlip()
    : EscherBitmapBlip(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void poi::ddf::EscherBitmapBlip::ctor()
{
    super::ctor();
    init();
}

void poi::ddf::EscherBitmapBlip::init()
{
    field_1_UID = new ::int8_tArray(int32_t(16));
    field_2_marker = static_cast< int8_t >(int32_t(255));
}

constexpr int16_t poi::ddf::EscherBitmapBlip::RECORD_ID_JPEG;

constexpr int16_t poi::ddf::EscherBitmapBlip::RECORD_ID_PNG;

constexpr int16_t poi::ddf::EscherBitmapBlip::RECORD_ID_DIB;

constexpr int32_t poi::ddf::EscherBitmapBlip::HEADER_SIZE;

int32_t poi::ddf::EscherBitmapBlip::fillFields(::int8_tArray* data, int32_t offset, EscherRecordFactory* recordFactory)
{
...
int32_t poi::ddf::EscherBitmapBlip::serialize(int32_t offset, ::int8_tArray* data, EscherSerializationListener* listener)
{
    ...
    ::poi::util::LittleEndian::putInt(data, offset + int32_t(4), getRecordSize() - HEADER_SIZE);
    auto pos = offset + HEADER_SIZE;
...
int32_t poi::ddf::EscherBitmapBlip::getRecordSize()
{
    return int32_t(8) + int32_t(16) + int32_t(1)+ npc(getPicturedata())->length;
}

int8_tArray* poi::ddf::EscherBitmapBlip::getUID()
{
    return field_1_UID;
}

void poi::ddf::EscherBitmapBlip::setUID(::int8_tArray* field_1_UID)
{
...
int8_t poi::ddf::EscherBitmapBlip::getMarker()
{
    return field_2_marker;
}

void poi::ddf::EscherBitmapBlip::setMarker(int8_t field_2_marker)
{
    this->field_2_marker = field_2_marker;
}

java::lang::ObjectArrayArray* poi::ddf::EscherBitmapBlip::getAttributeMap()
{
...
java::lang::Class* poi::ddf::EscherBitmapBlip::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ddf.EscherBitmapBlip", 35);
    return c;
}

int32_t poi::ddf::EscherBitmapBlip::fillFields(::int8_tArray* data, EscherRecordFactory* f)
{
    return super::fillFields(data, f);
}

int8_tArray* poi::ddf::EscherBitmapBlip::serialize()
{
    return super::serialize();
}

int32_t poi::ddf::EscherBitmapBlip::serialize(int32_t offset, ::int8_tArray* data)
{
    return super::serialize(offset, data);
}

java::lang::Class* poi::ddf::EscherBitmapBlip::getClass0()
{
    return class_();
}
