...
poi::ddf::EscherBSERecord::EscherBSERecord(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ddf::EscherBSERecord::EscherBSERecord() 
    : EscherBSERecord(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void poi::ddf::EscherBSERecord::init()
{
    field_3_uid = new ::int8_tArray(int32_t(16));
    _remainingData = new ::int8_tArray(int32_t(0));
}

constexpr int16_t poi::ddf::EscherBSERecord::RECORD_ID;

java::lang::String*& poi::ddf::EscherBSERecord::RECORD_DESCRIPTION()
{
    clinit();
    return RECORD_DESCRIPTION_;
}
java::lang::String* poi::ddf::EscherBSERecord::RECORD_DESCRIPTION_;

constexpr int8_t poi::ddf::EscherBSERecord::BT_ERROR;

constexpr int8_t poi::ddf::EscherBSERecord::BT_UNKNOWN;

constexpr int8_t poi::ddf::EscherBSERecord::BT_EMF;

constexpr int8_t poi::ddf::EscherBSERecord::BT_WMF;

constexpr int8_t poi::ddf::EscherBSERecord::BT_PICT;

constexpr int8_t poi::ddf::EscherBSERecord::BT_JPEG;

constexpr int8_t poi::ddf::EscherBSERecord::BT_PNG;

constexpr int8_t poi::ddf::EscherBSERecord::BT_DIB;

void poi::ddf::EscherBSERecord::ctor()
{
    super::ctor();
    init();
...
int32_t poi::ddf::EscherBSERecord::fillFields(::int8_tArray* data, int32_t offset, EscherRecordFactory* recordFactory)
{
    ...
    field_4_tag = ::poi::util::LittleEndian::getShort(data, pos + int32_t(18));
    field_5_size = ::poi::util::LittleEndian::getInt(data, pos + int32_t(20));
    field_6_ref = ::poi::util::LittleEndian::getInt(data, pos + int32_t(24));
    field_7_offset = ::poi::util::LittleEndian::getInt(data, pos + int32_t(28));
...
int32_t poi::ddf::EscherBSERecord::serialize(int32_t offset, ::int8_tArray* data, EscherSerializationListener* listener)
{
    ...
    ::poi::util::LittleEndian::putShort(data, offset + int32_t(26), field_4_tag);
    ::poi::util::LittleEndian::putInt(data, offset + int32_t(28), field_5_size);
    ::poi::util::LittleEndian::putInt(data, offset + int32_t(32), field_6_ref);
    ::poi::util::LittleEndian::putInt(data, offset + int32_t(36), field_7_offset);
...
int32_t poi::ddf::EscherBSERecord::getRecordSize()
{
...
java::lang::String* poi::ddf::EscherBSERecord::getRecordName()
{
    return u"BSE"_j;
}

int8_t poi::ddf::EscherBSERecord::getBlipTypeWin32()
{
    return field_1_blipTypeWin32;
}

void poi::ddf::EscherBSERecord::setBlipTypeWin32(int8_t blipTypeWin32)
{
    field_1_blipTypeWin32 = blipTypeWin32;
}

int8_t poi::ddf::EscherBSERecord::getBlipTypeMacOS()
{
    return field_2_blipTypeMacOS;
}

void poi::ddf::EscherBSERecord::setBlipTypeMacOS(int8_t blipTypeMacOS)
{
    field_2_blipTypeMacOS = blipTypeMacOS;
}

int8_tArray* poi::ddf::EscherBSERecord::getUid()
{
    return field_3_uid;
}

void poi::ddf::EscherBSERecord::setUid(::int8_tArray* uid)
{
...
int16_t poi::ddf::EscherBSERecord::getTag()
{
    return field_4_tag;
}

void poi::ddf::EscherBSERecord::setTag(int16_t tag)
{
    field_4_tag = tag;
}

int32_t poi::ddf::EscherBSERecord::getSize()
{
    return field_5_size;
}

void poi::ddf::EscherBSERecord::setSize(int32_t size)
{
    field_5_size = size;
}

int32_t poi::ddf::EscherBSERecord::getRef()
{
    return field_6_ref;
}

void poi::ddf::EscherBSERecord::setRef(int32_t ref)
{
    field_6_ref = ref;
}

int32_t poi::ddf::EscherBSERecord::getOffset()
{
    return field_7_offset;
}

void poi::ddf::EscherBSERecord::setOffset(int32_t offset)
{
    field_7_offset = offset;
}

int8_t poi::ddf::EscherBSERecord::getUsage()
{
    return field_8_usage;
}

void poi::ddf::EscherBSERecord::setUsage(int8_t usage)
{
    field_8_usage = usage;
}

int8_t poi::ddf::EscherBSERecord::getName()
{
    return field_9_name;
}

void poi::ddf::EscherBSERecord::setName(int8_t name)
{
    field_9_name = name;
}

int8_t poi::ddf::EscherBSERecord::getUnused2()
{
    return field_10_unused2;
}

void poi::ddf::EscherBSERecord::setUnused2(int8_t unused2)
{
    field_10_unused2 = unused2;
}

int8_t poi::ddf::EscherBSERecord::getUnused3()
{
    return field_11_unused3;
}

void poi::ddf::EscherBSERecord::setUnused3(int8_t unused3)
{
    field_11_unused3 = unused3;
}

poi::ddf::EscherBlipRecord* poi::ddf::EscherBSERecord::getBlipRecord()
{
    return field_12_blipRecord;
}

void poi::ddf::EscherBSERecord::setBlipRecord(EscherBlipRecord* blipRecord)
{
    field_12_blipRecord = blipRecord;
}

int8_tArray* poi::ddf::EscherBSERecord::getRemainingData()
{
    return _remainingData;
}

void poi::ddf::EscherBSERecord::setRemainingData(::int8_tArray* remainingData)
{
    _remainingData = (remainingData == nullptr) ? new ::int8_tArray(int32_t(0)) : npc(remainingData)->clone();
}

java::lang::String* poi::ddf::EscherBSERecord::getBlipType(int8_t b)
{
    clinit();
    switch (b) {
    case BT_ERROR:
...
java::lang::ObjectArrayArray* poi::ddf::EscherBSERecord::getAttributeMap()
{
...
java::lang::Class* poi::ddf::EscherBSERecord::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ddf.EscherBSERecord", 34);
    return c;
}

void poi::ddf::EscherBSERecord::clinit()
{
struct string_init_ {
    string_init_() {
...
int32_t poi::ddf::EscherBSERecord::fillFields(::int8_tArray* data, EscherRecordFactory* f)
{
    return super::fillFields(data, f);
}

int8_tArray* poi::ddf::EscherBSERecord::serialize()
{
    return super::serialize();
}

int32_t poi::ddf::EscherBSERecord::serialize(int32_t offset, ::int8_tArray* data)
{
    return super::serialize(offset, data);
}

java::lang::Class* poi::ddf::EscherBSERecord::getClass0()
{
    return class_();
}
