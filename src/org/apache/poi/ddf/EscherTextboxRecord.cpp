...
poi::ddf::EscherTextboxRecord::EscherTextboxRecord(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ddf::EscherTextboxRecord::EscherTextboxRecord() 
    : EscherTextboxRecord(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void poi::ddf::EscherTextboxRecord::init()
{
    thedata = EscherTextboxRecord::NO_BYTES_;
}

constexpr int16_t poi::ddf::EscherTextboxRecord::RECORD_ID;

java::lang::String*& poi::ddf::EscherTextboxRecord::RECORD_DESCRIPTION()
{
    clinit();
    return RECORD_DESCRIPTION_;
}
java::lang::String* poi::ddf::EscherTextboxRecord::RECORD_DESCRIPTION_;

int8_tArray*& poi::ddf::EscherTextboxRecord::NO_BYTES()
{
    clinit();
    return NO_BYTES_;
}
int8_tArray* poi::ddf::EscherTextboxRecord::NO_BYTES_;

void poi::ddf::EscherTextboxRecord::ctor()
{
    super::ctor();
    init();
}

int32_t poi::ddf::EscherTextboxRecord::fillFields(::int8_tArray* data, int32_t offset, EscherRecordFactory* recordFactory)
{
...
int32_t poi::ddf::EscherTextboxRecord::serialize(int32_t offset, ::int8_tArray* data, EscherSerializationListener* listener)
{
    ...
    if(size != getRecordSize()) {
        throw new ::poi::util::RecordFormatException(::java::lang::StringBuilder().append(size)->append(u" bytes written but getRecordSize() reports "_j)
            ->append(getRecordSize())->toString());
    }
    return size;
}

int8_tArray* poi::ddf::EscherTextboxRecord::getData()
{
    return thedata;
}

void poi::ddf::EscherTextboxRecord::setData(::int8_tArray* b, int32_t start, int32_t length)
{
    thedata = new ::int8_tArray(length);
    ::java::lang::System::arraycopy(b, start, thedata, 0, length);
}

void poi::ddf::EscherTextboxRecord::setData(::int8_tArray* b)
{
    setData(b, 0, npc(b)->length);
}

int32_t poi::ddf::EscherTextboxRecord::getRecordSize()
{
    return int32_t(8) + npc(thedata)->length;
}

poi::ddf::EscherTextboxRecord* poi::ddf::EscherTextboxRecord::clone()
{
...
java::lang::String* poi::ddf::EscherTextboxRecord::getRecordName()
{
    return u"ClientTextbox"_j;
}

java::lang::ObjectArrayArray* poi::ddf::EscherTextboxRecord::getAttributeMap()
{
...
java::lang::Class* poi::ddf::EscherTextboxRecord::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ddf.EscherTextboxRecord", 38);
    return c;
}

void poi::ddf::EscherTextboxRecord::clinit()
{
struct string_init_ {
    string_init_() {
...
int32_t poi::ddf::EscherTextboxRecord::fillFields(::int8_tArray* data, EscherRecordFactory* f)
{
    return super::fillFields(data, f);
}

int8_tArray* poi::ddf::EscherTextboxRecord::serialize()
{
    return super::serialize();
}

int32_t poi::ddf::EscherTextboxRecord::serialize(int32_t offset, ::int8_tArray* data)
{
    return super::serialize(offset, data);
}

java::lang::Class* poi::ddf::EscherTextboxRecord::getClass0()
{
    return class_();
}
