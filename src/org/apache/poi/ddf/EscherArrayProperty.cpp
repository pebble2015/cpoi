...
poi::ddf::EscherArrayProperty::EscherArrayProperty(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

poi::ddf::EscherArrayProperty::EscherArrayProperty(int16_t id, ::int8_tArray* complexData) 
    : EscherArrayProperty(*static_cast< ::default_init_tag* >(0))
{
    ctor(id,complexData);
}

poi::ddf::EscherArrayProperty::EscherArrayProperty(int16_t propertyNumber, bool isBlipId, ::int8_tArray* complexData) 
    : EscherArrayProperty(*static_cast< ::default_init_tag* >(0))
{
    ctor(propertyNumber,isBlipId,complexData);
}

void poi::ddf::EscherArrayProperty::init()
{
    sizeIncludesHeaderSize = true;
}

constexpr int32_t poi::ddf::EscherArrayProperty::FIXED_SIZE;

void poi::ddf::EscherArrayProperty::ctor(int16_t id, ::int8_tArray* complexData)
{
...
void poi::ddf::EscherArrayProperty::ctor(int16_t propertyNumber, bool isBlipId, ::int8_tArray* complexData)
{
    super::ctor(propertyNumber, isBlipId, checkComplexData(complexData));
    init();
}

int8_tArray* poi::ddf::EscherArrayProperty::checkComplexData(::int8_tArray* complexData)
{
    clinit();
...
int32_t poi::ddf::EscherArrayProperty::getNumberOfElementsInArray_()
{
    return (emptyComplexPart) ? int32_t(0) : ::poi::util::LittleEndian::getUShort(getComplexData(), 0);
}

void poi::ddf::EscherArrayProperty::setNumberOfElementsInArray_(int32_t numberOfElements)
{
    ...
    ::poi::util::LittleEndian::putShort(getComplexData(), 0, static_cast< int16_t >(numberOfElements));
}

int32_t poi::ddf::EscherArrayProperty::getNumberOfElementsInMemory()
{
    return (emptyComplexPart) ? int32_t(0) : ::poi::util::LittleEndian::getUShort(getComplexData(), 2);
}

void poi::ddf::EscherArrayProperty::setNumberOfElementsInMemory(int32_t numberOfElements)
{
    auto expectedArraySize = numberOfElements * getActualSizeOfElements(getSizeOfElements()) + FIXED_SIZE;
    if(expectedArraySize != npc(getComplexData())->length) {
        auto newArray_ = new ::int8_tArray(expectedArraySize);
    ...
    ::poi::util::LittleEndian::putShort(getComplexData(), 2, static_cast< int16_t >(numberOfElements));
}

int16_t poi::ddf::EscherArrayProperty::getSizeOfElements()
{
    return (emptyComplexPart) ? static_cast< int16_t >(int32_t(0)) : ::poi::util::LittleEndian::getShort(getComplexData(), 4);
}

void poi::ddf::EscherArrayProperty::setSizeOfElements(int32_t sizeOfElements)
{
    ::poi::util::LittleEndian::putShort(getComplexData(), 4, static_cast< int16_t >(sizeOfElements));
...
int8_tArray* poi::ddf::EscherArrayProperty::getElement(int32_t index)
{
...
void poi::ddf::EscherArrayProperty::setElement(int32_t index, ::int8_tArray* element)
{
    auto actualSize = getActualSizeOfElements(getSizeOfElements());
    ::java::lang::System::arraycopy(element, 0, getComplexData(), FIXED_SIZE + index * actualSize, actualSize);
}

java::lang::String* poi::ddf::EscherArrayProperty::toString()
{
    ...
    for (auto i = int32_t(0); i < getNumberOfElementsInArray_(); i++) {
        npc(npc(npc(npc(npc(results)->append(u"     Element "_j))->append(i))->append(u": "_j))->append(::poi::util::HexDump::toHex(getElement(i))))->append(u'\u000a');
    }
    npc(results)->append(::java::lang::StringBuilder().append(u"}"_j)->append(u'\u000a')->toString());
    return npc(results)->toString();
}

java::lang::String* poi::ddf::EscherArrayProperty::toXml(::java::lang::String* tab)
{
    auto builder = new ::java::lang::StringBuilder();
    npc(npc(npc(npc(npc(npc(npc(npc(npc(npc(builder)->append(tab))->append(u"<"_j))->append(npc(getClass())->getSimpleName()))->append(u" id=\"0x"_j))->append(::poi::util::HexDump::toHex(getId())))->append(u"\" name=\""_j))->append(getName()))->append(u"\" blipId=\""_j))->append(isBlipId()))->append(u"\">\n"_j);
    for (auto i = int32_t(0); i < getNumberOfElementsInArray_(); i++) {
        npc(npc(npc(npc(npc(builder)->append(u"\t"_j))->append(tab))->append(u"<Element>"_j))->append(::poi::util::HexDump::toHex(getElement(i))))->append(u"</Element>\n"_j);
    }
    npc(npc(npc(npc(builder)->append(tab))->append(u"</"_j))->append(npc(getClass())->getSimpleName()))->append(u">"_j);
    return npc(builder)->toString();
}

int32_t poi::ddf::EscherArrayProperty::setArrayData(::int8_tArray* data, int32_t offset)
{
    if(emptyComplexPart) {
        setComplexData(new ::int8_tArray(int32_t(0)));
    } else {
        auto numElements = ::poi::util::LittleEndian::getShort(data, offset);
        auto sizeOfElements = ::poi::util::LittleEndian::getShort(data, offset + int32_t(4));
...
int32_t poi::ddf::EscherArrayProperty::serializeSimplePart(::int8_tArray* data, int32_t pos)
{
    ::poi::util::LittleEndian::putShort(data, pos, getId());
    auto recordSize = npc(getComplexData())->length;
    if(!sizeIncludesHeaderSize) {
        recordSize -= 6;
    }
    ::poi::util::LittleEndian::putInt(data, pos + int32_t(2), recordSize);
    return 6;
}

int32_t poi::ddf::EscherArrayProperty::getActualSizeOfElements(int16_t sizeOfElements)
{
    clinit();
    if(sizeOfElements < 0) {
...
java::util::Iterator* poi::ddf::EscherArrayProperty::iterator()
{
...
java::lang::Class* poi::ddf::EscherArrayProperty::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.apache.poi.ddf.EscherArrayProperty", 38);
    return c;
}

java::lang::Class* poi::ddf::EscherArrayProperty::getClass0()
{
    return class_();
}
